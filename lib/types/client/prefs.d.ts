...
import { clampTerminalFontSize, clampTitleBarStrip, clampWidthPercent, HOTKEY_TOGGLE_TARGETS, SIDEBAR_PREFS_DEFAULTS, TITLE_BAR_SCHEMES, TITLE_BAR_STRIP_DEFAULT, type HotkeyToggleTarget, type SidebarPrefs, type TitleBarScheme } from '../prefs-shared.ts';
export { HOTKEY_TOGGLE_TARGETS, SIDEBAR_PREFS_DEFAULTS, TITLE_BAR_SCHEMES, TITLE_BAR_STRIP_DEFAULT, clampTerminalFontSize, clampTitleBarStrip, clampWidthPercent, };
...
export declare function isHotkeyToggleTarget(value: unknown): value is HotkeyToggleTarget;
/**
