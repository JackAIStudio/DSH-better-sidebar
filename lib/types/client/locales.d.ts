...
export declare const zh: {
    ...
    settingsHotkeyToggleTitle: string;
    settingsHotkeyToggleDesc: string;
    settingsHotkeyToggleBoth: string;
    settingsHotkeyTogglePanel: string;
    settingsHotkeyToggleBottom: string;
