window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			settingsHotkeyToggleTitle: "快捷键切换目标 (Cmd/Ctrl + J)",
			settingsHotkeyToggleDesc: "选择按下 Cmd/Ctrl + J 时展开或收起的面板",
			settingsHotkeyToggleBoth: "全部面板（右侧与底部）",
			settingsHotkeyTogglePanel: "仅右侧边栏",
			settingsHotkeyToggleBottom: "仅底部面板",
		...
		const en = {
			...
			settingsHotkeyToggleTitle: "Hotkey toggle target (Cmd/Ctrl + J)",
			settingsHotkeyToggleDesc: "Select which panels expand or collapse when pressing Cmd/Ctrl + J",
			settingsHotkeyToggleBoth: "Both panels (right & bottom)",
			settingsHotkeyTogglePanel: "Right sidebar only",
			settingsHotkeyToggleBottom: "Bottom panel only",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jkw/Documents/dshspace/plugins/dsh-better-sidebar/src/client/sidebar.module.css.mjs
		const css$6 = "[data-dsh-panel-host]{z-index:25;pointer-events:none;position:fixed;inset:0;overflow:clip}[data-dsh-panel-host][data-dsh-panel-host-degraded]{position:absolute;top:0;left:0}.sFkTnW_toggleCluster{top:calc(3px + env(safe-area-inset-top));z-index:45;pointer-events:auto;transition:top var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex-direction:row;gap:4px;display:flex;position:absolute;right:10px}.sFkTnW_panel:not(.sFkTnW_panelHidden) .sFkTnW_tabBar{padding-right:72px}.sFkTnW_toggleButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out), color var(--ds-transition-duration-slow) var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;justify-content:center;align-items:center;display:flex}.sFkTnW_toggleButton:hover:not(:disabled):not([aria-disabled=true]){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_toggleButton:disabled,.sFkTnW_toggleButton[aria-disabled=true]{opacity:.4;cursor:default}.sFkTnW_panel{box-sizing:border-box;z-index:40;pointer-events:auto;background:var(--dsw-alias-bg-layer-1);border-left:1px solid var(--dsw-alias-border-l2);padding-bottom:env(safe-area-inset-bottom);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), width var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex-direction:column;display:flex;position:absolute;top:0;bottom:0;right:0}.sFkTnW_panelHidden{pointer-events:none;visibility:hidden;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), width var(--ds-transition-duration-slow) var(--ds-ease-in-out), visibility 0s linear var(--ds-transition-duration-slow);transform:translate(102%)}.sFkTnW_panel[data-dragging]{transition:none}.sFkTnW_panelResize{cursor:col-resize;z-index:2;touch-action:none;width:8px;position:absolute;top:0;bottom:0;left:-4px}.sFkTnW_panelResizeActive{background:var(--dsw-alias-interactive-bg-hover-accent)}.sFkTnW_panelBody{flex:1;min-width:0;min-height:0;display:flex}.sFkTnW_bottomPanel{z-index:40;background:var(--dsw-alias-bg-layer-1);border-top:1px solid var(--dsw-alias-border-l2);pointer-events:auto;padding-bottom:env(safe-area-inset-bottom);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), height var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex-direction:column;display:flex;position:absolute;bottom:0}.sFkTnW_bottomPanelHidden{pointer-events:none;visibility:hidden;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), height var(--ds-transition-duration-slow) var(--ds-ease-in-out), visibility 0s linear var(--ds-transition-duration-slow);transform:translateY(102%)}.sFkTnW_bottomPanel[data-dragging]{transition:none}.sFkTnW_panel,.sFkTnW_bottomPanel{contain:layout style}body[data-dsh-sidebar-dragging] .sFkTnW_panel,body[data-dsh-sidebar-dragging] .sFkTnW_bottomPanel{will-change:transform}.sFkTnW_bottomResize{cursor:row-resize;z-index:2;touch-action:none;height:8px;position:absolute;top:-4px;left:0;right:0}.sFkTnW_bottomResizeActive{background:var(--dsw-alias-interactive-bg-hover-accent)}.sFkTnW_bottomClose{z-index:4;width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex;position:absolute;top:3px;right:6px}.sFkTnW_bottomClose:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_bottomPanel .sFkTnW_tabBar{padding-right:40px}.sFkTnW_floatWindow{z-index:42;pointer-events:auto;background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l2);box-shadow:var(--dsw-shadow-lv3);contain:layout style;border-radius:8px;flex-direction:column;display:flex;position:absolute;overflow:hidden}.sFkTnW_floatWindowDragging{will-change:left, top, width, height}.sFkTnW_floatHeader{height:34px;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);border-bottom:1px solid var(--dsw-alias-border-l1);cursor:grab;user-select:none;flex:none;align-items:center;gap:4px;padding:0 4px 0 10px;display:flex}.sFkTnW_floatWindowDragging .sFkTnW_floatHeader{cursor:grabbing}.sFkTnW_floatTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.sFkTnW_floatClose{width:18px;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.sFkTnW_floatClose:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_floatContent{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;overflow:hidden}.sFkTnW_floatResize{z-index:2;cursor:nwse-resize;touch-action:none;width:14px;height:14px;position:absolute;bottom:0;right:0}.sFkTnW_floatResize:hover{background:var(--dsw-alias-interactive-bg-hover-accent)}.sFkTnW_pane[data-dsh-float-dock-over]{outline:2px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-2px}.sFkTnW_floatDropHint{z-index:46;pointer-events:none;border:2px dashed var(--dsw-alias-interactive-bg-hover-accent);background:color-mix(in srgb, var(--dsw-alias-interactive-bg-hover-accent) 12%, transparent);border-radius:8px;justify-content:center;align-items:center;display:flex;position:absolute}.sFkTnW_floatDropHintLabel{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l2);border-radius:999px;padding:4px 12px}.sFkTnW_toggleCluster,.sFkTnW_toggleButton,.sFkTnW_tabBar,.sFkTnW_floatHeader{-webkit-app-region:no-drag}body[data-dsh-title-bar-compat] .sFkTnW_toggleCluster{top:calc(var(--dsh-title-bar-strip,40px) + 3px)}body[data-dsh-title-bar-compat] .sFkTnW_panel{padding-top:var(--dsh-title-bar-strip,40px)}body[data-dsh-sidebar-collapsed] .sFkTnW_toggleCluster{top:calc(14px + env(safe-area-inset-top))}body[data-dsh-sidebar-collapsed][data-dsh-title-bar-compat] .sFkTnW_toggleCluster{top:calc(var(--dsh-title-bar-strip,40px) + 14px)}.sFkTnW_cornerHandle{left:-6px;bottom:calc(var(--dsh-sidebar-height,0px) + 6px);z-index:2;cursor:nwse-resize;touch-action:none;width:12px;height:12px;position:absolute}.sFkTnW_cornerHandle:hover,.sFkTnW_cornerHandle[data-dragging]{background:var(--dsw-alias-interactive-bg-hover-accent)}.sFkTnW_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.sFkTnW_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_iconButton:disabled{opacity:.4;cursor:default}.sFkTnW_workbench,.sFkTnW_split{flex:1;min-width:0;min-height:0;display:flex}.sFkTnW_splitRow{flex-direction:row}.sFkTnW_splitCol{flex-direction:column}.sFkTnW_splitChild{display:flex;position:relative;overflow:hidden}.sFkTnW_divider{z-index:3;touch-action:none;flex:none;position:relative}.sFkTnW_dividerRow:after,.sFkTnW_dividerCol:after{content:\"\";background:var(--dsw-alias-border-l2);transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out);position:absolute}.sFkTnW_dividerRow{cursor:col-resize;width:7px;margin:0 -2px}.sFkTnW_dividerRow:after{width:1px;top:0;bottom:0;left:50%;transform:translate(-50%)}.sFkTnW_dividerCol{cursor:row-resize;height:7px;margin:-2px 0}.sFkTnW_dividerCol:after{height:1px;top:50%;left:0;right:0;transform:translateY(-50%)}.sFkTnW_divider:hover:after,.sFkTnW_dividerActive:after{background:var(--dsw-alias-interactive-bg-hover-accent)}.sFkTnW_pane{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative}.sFkTnW_paneDrop{outline:1px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}.sFkTnW_dropOverlay{z-index:6;pointer-events:none;background:var(--dsw-alias-interactive-bg-hover-accent);opacity:.5;position:absolute}.sFkTnW_dropLeft{width:25%;top:0;bottom:0;left:0}.sFkTnW_dropRight{width:25%;top:0;bottom:0;right:0}.sFkTnW_dropUp{height:25%;top:0;left:0;right:0}.sFkTnW_dropDown{height:25%;bottom:0;left:0;right:0}.sFkTnW_dropCenter{outline:2px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-2px;background:0 0;inset:25%}.sFkTnW_paneContent{flex-direction:column;flex:1;min-height:0;display:flex;overflow:hidden}.sFkTnW_paneTab{flex-direction:column;flex:1;min-height:0;display:flex}.sFkTnW_paneTabHidden{display:none}.sFkTnW_paneEmptyCards{flex:1;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));align-content:start;gap:8px;min-height:0;padding:12px;display:grid;overflow:hidden}.sFkTnW_paneCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-strong-12);cursor:pointer;text-align:center;border-radius:8px;flex-direction:column;justify-content:center;align-items:center;gap:6px;padding:12px 8px;display:flex}.sFkTnW_paneCard:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-border-l2)}.sFkTnW_paneCard:disabled{opacity:.45;cursor:default}.sFkTnW_tabBar{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);flex:none;align-items:stretch;height:34px;display:flex}.sFkTnW_tabBarDrop{outline:1px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}.sFkTnW_tabList{scrollbar-width:none;flex:1;min-width:0;display:flex;overflow-x:auto}.sFkTnW_tabList::-webkit-scrollbar{display:none}.sFkTnW_tab{min-width:64px;max-width:160px;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);border-right:1px solid var(--dsw-alias-border-l1);cursor:pointer;user-select:none;background:0 0;flex:none;align-items:center;gap:4px;padding:0 4px 0 10px;display:flex}.sFkTnW_tab:hover{background:var(--dsw-alias-interactive-bg-hover)}.sFkTnW_tabActive{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-active)}.sFkTnW_tabTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.sFkTnW_tabBadge{min-width:16px;height:15px;font:var(--dsw-font-xxxs-strong-11);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-brand-primary);border-radius:8px;flex:none;justify-content:center;align-items:center;padding:0 4px;display:inline-flex}.sFkTnW_tabClose{width:18px;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.sFkTnW_tabClose:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_tabBarPlus{background:var(--dsw-alias-bg-layer-1);width:22px;height:22px;color:var(--dsw-alias-label-tertiary);cursor:pointer;border:none;border-radius:5px;flex:none;justify-content:center;align-self:center;align-items:center;margin:0 6px;padding:0;display:inline-flex;position:sticky;right:0}.sFkTnW_tabBarPlus:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_pinnedTab{color:var(--dsw-alias-label-tertiary);font-style:italic}.sFkTnW_pinnedTab:hover{color:var(--dsw-alias-label-secondary)}.sFkTnW_explorer{flex-direction:column;flex:1;min-height:0;display:flex}.sFkTnW_explorerHeader{flex:none;justify-content:space-between;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.sFkTnW_explorerRoot{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.sFkTnW_explorerBody{flex:1;min-height:0;padding:4px 8px 8px;overflow:hidden auto}.sFkTnW_explorerRow{box-sizing:border-box;width:100%;max-width:100%;height:34px;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;white-space:nowrap;animation:sFkTnW_dsh-row-in .15s var(--ds-ease-in-out);background:0 0;border:none;border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.sFkTnW_explorerRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.sFkTnW_explorerRowRevealed{background:var(--dsw-alias-state-business-tertiary)}.sFkTnW_explorerRowRevealed+.sFkTnW_explorerRowRevealed{border-top-left-radius:0;border-top-right-radius:0}.sFkTnW_explorerRowRevealed:has(+.sFkTnW_explorerRowRevealed){border-bottom-right-radius:0;border-bottom-left-radius:0}.sFkTnW_explorerDir{font:var(--dsw-font-s-strong-14)}.sFkTnW_explorerHidden{opacity:.45}.sFkTnW_explorerSymlink{color:var(--dsw-alias-label-tertiary);flex:none}.sFkTnW_explorerBroken .sFkTnW_explorerName{color:var(--dsw-alias-state-error-primary)}.sFkTnW_explorerName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.sFkTnW_explorerRenaming{cursor:text}.sFkTnW_explorerRenameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1);min-width:0;height:24px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:auto;padding:0 6px}.sFkTnW_explorerRenameInput:focus{border-color:var(--dsw-alias-state-business-primary);outline:none}.sFkTnW_explorerActionError{box-sizing:border-box;border:1px solid var(--dsw-alias-state-error-primary);background:var(--dsw-alias-bg-layer-1);border-radius:8px;align-items:flex-start;gap:6px;width:100%;margin-bottom:4px;padding:6px 8px;display:flex}.sFkTnW_explorerActionErrorText{overflow-wrap:anywhere;min-width:0;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex:auto}.sFkTnW_explorerActionErrorClose{width:20px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:5px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.sFkTnW_explorerActionErrorClose:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_explorerConfirmDesc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);overflow-wrap:anywhere;margin:0}.sFkTnW_explorerRef,.sFkTnW_explorerCopied{margin-left:auto}.sFkTnW_explorerRef{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);height:20px;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;border-radius:999px;flex:none;align-items:center;padding:0 8px;display:none}.sFkTnW_explorerRef:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_explorerRow:hover .sFkTnW_explorerRef,.sFkTnW_explorerRow:focus-within .sFkTnW_explorerRef{display:inline-flex}.sFkTnW_explorerCopied{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}.sFkTnW_explorerError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);cursor:default}@keyframes sFkTnW_dsh-row-in{0%{opacity:0}}.sFkTnW_explorerEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}.sFkTnW_explorerRowDropTarget{background:var(--dsw-alias-interactive-bg-hover);outline:1px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}.sFkTnW_uploadDropZone{z-index:1001;pointer-events:none;border:2px dashed var(--dsw-alias-interactive-bg-hover-accent);box-shadow:0 0 0 200vmax var(--dsw-alias-bg-mask-drop);animation:sFkTnW_dsh-row-in .15s var(--ds-ease-in-out);border-radius:10px;justify-content:center;align-items:flex-start;padding:12px;display:flex;position:fixed}.sFkTnW_uploadDropHero{flex-direction:column;align-items:center;gap:10px;max-width:100%;padding-top:8px;display:flex}.sFkTnW_uploadDropZonePill{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-width:100%;box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-strong-12);border-radius:999px;align-items:center;gap:6px;padding:6px 12px;display:flex}.sFkTnW_uploadDropZoneText{white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.sFkTnW_uploadDropChatHint{z-index:1002;pointer-events:none;animation:sFkTnW_dsh-row-in .15s var(--ds-ease-in-out);justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;top:0;bottom:0;left:0}.sFkTnW_uploadDropChatCard{text-align:center;max-width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-s-strong-14);flex-direction:column;align-items:center;gap:12px;display:flex}.sFkTnW_uploadOverlay{z-index:30;background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);animation:sFkTnW_dsh-row-in .15s var(--ds-ease-in-out);justify-content:center;align-items:center;display:flex;position:absolute;inset:0}.sFkTnW_uploadOverlayCard{border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-alias-bg-layer-2);min-width:280px;max-width:min(420px,100% - 48px);box-shadow:var(--dsw-shadow-lv3);border-radius:24px;flex-direction:column;gap:12px;padding:20px 24px;display:flex}.sFkTnW_uploadOverlayTitle{font:var(--dsw-font-s-strong-14);color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.sFkTnW_uploadOverlayTitle>svg{flex:none}.sFkTnW_uploadOverlayTitle>span{white-space:nowrap;text-overflow:ellipsis;min-width:0;overflow:hidden}.sFkTnW_uploadOverlayProgress{background:var(--dsw-alias-border-l2);border-radius:3px;height:6px;overflow:hidden}.sFkTnW_uploadOverlayProgressFill{background:var(--dsw-alias-interactive-bg-hover-accent);height:100%;transition:width .15s var(--ds-ease-in-out);border-radius:3px}.sFkTnW_uploadOverlayStatus{min-height:1em;font:var(--dsw-font-xxs-12);font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.sFkTnW_uploadOverlayCancel{border:1px solid var(--dsw-alias-border-l2);height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-strong-12);cursor:pointer;background:0 0;border-radius:8px;align-self:flex-end;padding:0 14px}.sFkTnW_uploadOverlayCancel:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-border-l2)}.sFkTnW_uploadOverlayCancel:disabled{opacity:.4;cursor:default}.sFkTnW_editor{flex-direction:column;flex:1;min-height:0;display:flex}.sFkTnW_editorHeader{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:6px;padding:6px 8px;display:flex}.sFkTnW_editorTitle{min-width:0;font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.sFkTnW_editorPathInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 10px}.sFkTnW_editorPathInput:focus{border-color:var(--dsw-alias-border-l2);outline:none}.sFkTnW_editorTreeToggleActive{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-active)}.sFkTnW_editorBody{flex:1;min-height:0;display:flex}.sFkTnW_editorMain{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex}.sFkTnW_editorTreeDock{border-left:1px solid var(--dsw-alias-border-l1);flex:none;min-height:0;display:flex;position:relative}.sFkTnW_editorTreeResize{cursor:col-resize;touch-action:none;z-index:3;width:6px;position:absolute;top:0;bottom:0;left:0}.sFkTnW_editorTreeResize:hover{background:var(--dsw-alias-border-l2)}.sFkTnW_editorTreePanel{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative}.sFkTnW_editorTreePanelFull{flex:1}.sFkTnW_editorTreeSearch{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:6px;padding:6px 8px;display:flex}.sFkTnW_editorSearchInput{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;height:26px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 10px}.sFkTnW_editorSearchInput:focus{border-color:var(--dsw-alias-border-l2);outline:none}.sFkTnW_editorSearchHint{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);padding:8px 12px}.sFkTnW_editorSearchResult{width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);text-align:left;cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 8px;display:block;overflow:hidden}.sFkTnW_editorSearchResult:hover{background:var(--dsw-alias-interactive-bg-hover)}.sFkTnW_editorStatus{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}.sFkTnW_editorStatusError{color:var(--dsw-alias-state-error-primary)}.sFkTnW_dirtyDot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;flex:none;width:7px;height:7px}.sFkTnW_editorPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;flex:1;justify-content:center;align-items:center;padding:16px;display:flex}.sFkTnW_orphanedType{opacity:.7;overflow-wrap:anywhere;margin-top:8px;font-size:12px;display:block}.sFkTnW_editorBinary{text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:12px;padding:24px 16px;display:flex}.sFkTnW_editorBinaryNotice{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}.sFkTnW_editorDownloadLink{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-strong-12);cursor:pointer;transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out), border-color var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:6px;align-items:center;gap:6px;padding:6px 14px;text-decoration:none;display:inline-flex}.sFkTnW_editorDownloadLink:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-border-l2)}.sFkTnW_editorError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);padding:12px 16px}.sFkTnW_fenceError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-wrap:wrap;align-items:center;gap:8px;padding:8px 16px;display:flex}.sFkTnW_editorBanner{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex:none;padding:4px 8px}.sFkTnW_sandboxStatus{font:var(--dsw-font-xxxs-11);flex:none;align-items:center;gap:8px;padding:4px 10px;display:flex}.sFkTnW_sandboxStatusOn{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);border-bottom:1px solid var(--dsw-alias-border-l1)}.sFkTnW_sandboxStatusOff{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 10%, transparent);border-bottom:1px solid color-mix(in srgb, var(--dsw-alias-state-error-primary) 45%, transparent)}.sFkTnW_sandboxDot{background:var(--dsw-alias-state-success-primary);border-radius:50%;flex:none;width:6px;height:6px}.sFkTnW_sandboxStatusOff .sFkTnW_sandboxDot{background:var(--dsw-alias-state-error-primary)}.sFkTnW_sandboxStatusText{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.sFkTnW_sandboxAction{border:1px solid var(--dsw-alias-border-l2);font:inherit;color:inherit;cursor:pointer;background:0 0;border-radius:6px;flex:none;padding:2px 8px}.sFkTnW_sandboxAction:hover{background:var(--dsw-alias-interactive-bg-hover)}.sFkTnW_editorHtml{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}.sFkTnW_browser{flex-direction:column;flex:1;min-height:0;display:flex}.sFkTnW_browserBar{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:4px;padding:6px 8px;display:flex}.sFkTnW_browserInput{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 10px}.sFkTnW_browserInput:focus{border-color:var(--dsw-alias-border-l2);outline:none}.sFkTnW_browserMessage{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex:none;padding:4px 12px}.sFkTnW_browserFrame{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}.sFkTnW_browserStart{text-align:center;min-height:0;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);flex:1;justify-content:center;align-items:center;padding:20px;display:flex}.sFkTnW_browserBlocked{text-align:center;min-height:0;color:var(--dsw-alias-state-warn-primary);flex-direction:column;flex:1;justify-content:center;align-items:center;gap:6px;padding:24px;display:flex}.sFkTnW_browserBlockedTitle{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary)}.sFkTnW_browserBlockedDesc{max-width:280px;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-secondary)}.sFkTnW_browserBlockedActions{gap:8px;margin-top:6px;display:flex}.sFkTnW_browserBlockedButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxxs-11);cursor:pointer;border-radius:6px;padding:4px 12px}.sFkTnW_browserBlockedButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.sFkTnW_editorCm{background:0 0;flex:1;min-height:0;overflow:hidden}.sFkTnW_editorCmHidden{display:none}.sFkTnW_editorCm .cm-editor{height:100%}.sFkTnW_editorCm .cm-scroller{padding:12px 16px}.sFkTnW_editorCm .cm-editor.cm-focused{outline:none}.sFkTnW_editorModeToggle{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:6px;flex:none;align-items:center;gap:2px;padding:2px;display:inline-flex}.sFkTnW_editorModeButton{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-11);cursor:pointer;background:0 0;border:none;border-radius:4px;padding:2px 8px}.sFkTnW_editorModeButton:hover{color:var(--dsw-alias-label-primary)}.sFkTnW_editorModeActive{background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary)}.sFkTnW_editorImageWrap{flex:1;justify-content:center;align-items:center;min-height:0;padding:12px;display:flex;overflow:auto}.sFkTnW_editorImage{object-fit:contain;max-width:100%;max-height:100%}.sFkTnW_editorMd{min-height:0;font:var(--dsw-font-xs-13);flex:1;padding:12px 16px;overflow-y:auto}.sFkTnW_editorMd .md-code-block:not([data-mermaid-processed])>div:first-child{z-index:auto;position:static}.sFkTnW_mermaidWrap{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:6px;margin:6px 0;overflow:hidden}.sFkTnW_mermaidHeader{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);justify-content:space-between;align-items:center;gap:6px;padding:4px 8px;display:flex}.sFkTnW_mermaidInfo{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary)}.sFkTnW_mermaidCopy{height:20px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-11);cursor:pointer;background:0 0;border:none;border-radius:4px;align-items:center;gap:4px;padding:0 6px;display:inline-flex}.sFkTnW_mermaidCopy:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_mermaidBody{cursor:zoom-in;justify-content:center;padding:10px;display:flex;overflow:auto}.sFkTnW_mermaidBody svg{max-width:100%;height:auto}.sFkTnW_mermaidError{border-bottom:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-state-error-primary);font:var(--dsw-font-xxxs-11);padding:6px 10px}.sFkTnW_mermaidCode{font:var(--dsw-font-xxxs-11);margin:0;padding:8px 10px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;overflow:auto}.sFkTnW_mermaidMarkdown .md-code-block[data-mermaid-processed]{display:contents}.sFkTnW_mermaidModal{z-index:1000;background:var(--dsw-alias-bg-mask-1);backdrop-filter:blur(2px);flex-direction:column;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.sFkTnW_mermaidModalToolbar{z-index:10;gap:8px;display:flex;position:absolute;top:16px;right:16px}.sFkTnW_mermaidModalButton{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);width:36px;height:36px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xs-strong-13);cursor:pointer;border-radius:8px;justify-content:center;align-items:center;display:inline-flex}.sFkTnW_mermaidModalButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.sFkTnW_mermaidModalStage{justify-content:center;align-items:center;width:90vw;height:80vh;display:flex;position:relative;overflow:hidden}.sFkTnW_mermaidModalStage svg{cursor:grab;transform-origin:50%;user-select:none;-webkit-user-drag:none;background:var(--dsw-alias-bg-layer-1);border-radius:12px;max-width:none;max-height:none;padding:16px}.sFkTnW_mermaidModalStage svg:active{cursor:grabbing}.sFkTnW_mermaidModalHint{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-11);pointer-events:none;position:absolute;bottom:16px;left:50%;transform:translate(-50%)}.sFkTnW_selectionPopup{z-index:60;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxxs-strong-11);white-space:nowrap;cursor:pointer;border-radius:6px;align-items:center;padding:0 10px;display:inline-flex;position:fixed;transform:translate(-50%,calc(-100% - 8px))}.sFkTnW_selectionPopup:hover{background:var(--dsw-alias-interactive-bg-hover)}.sFkTnW_editorPdf{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-height:0;display:flex}.sFkTnW_editorPdfToolbar{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;justify-content:flex-end;padding:6px 8px;display:flex}.sFkTnW_editorPdfStage{flex:1;min-height:0;display:flex;position:relative}.sFkTnW_editorPdfFrame{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}.sFkTnW_editorPdfFrameBlocked{pointer-events:none}.sFkTnW_editorPdfDragShield{z-index:4;pointer-events:none;background:0 0;position:absolute;inset:0}.sFkTnW_editorPdfDragShieldActive{pointer-events:auto}body[data-dsh-tab-dragging] .sFkTnW_editorPdfFrame{pointer-events:none!important}body[data-dsh-tab-dragging] .sFkTnW_editorPdfDragShield{pointer-events:auto!important}.sFkTnW_terminalWrap{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.sFkTnW_terminal{flex:1;min-height:0;padding:6px 4px 6px 8px}.sFkTnW_terminal .xterm{height:100%}.sFkTnW_terminalBanner{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:3px 10px;display:flex}.sFkTnW_terminalBannerUrl{word-break:break-all;opacity:.85;flex-basis:100%;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.sFkTnW_boundaryError{z-index:50;background:var(--dsw-alias-bg-layer-1);border-left:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-direction:column;align-items:flex-start;gap:8px;padding:16px;display:flex;position:fixed;top:0;bottom:0;right:0;overflow:auto}.sFkTnW_terminalRetry{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;border-radius:999px;flex:none;padding:1px 8px}.sFkTnW_terminalRetry:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_terminalDepsBanner{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex-direction:column;flex:none;gap:6px;padding:10px;display:flex}.sFkTnW_terminalDepsTitle{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-state-warn-primary)}.sFkTnW_terminalDepsHint{opacity:.9}.sFkTnW_terminalDepsCommandRow{align-items:flex-start;gap:8px;display:flex}.sFkTnW_terminalRepairCommand{white-space:pre-wrap;word-break:break-all;user-select:text;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:4px;flex:1;max-height:160px;margin:0;padding:6px 8px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;line-height:1.5;overflow:auto}.sFkTnW_terminalDepsNote{opacity:.85}.sFkTnW_terminalDepsActions{align-items:center;gap:8px;display:flex}.sFkTnW_tabBoundaryError{min-height:0;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-direction:column;flex:1;align-items:flex-start;gap:8px;padding:12px 16px;display:flex;overflow:auto}.sFkTnW_gitEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);padding:4px 12px 8px}.sFkTnW_gitPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}.sFkTnW_gitError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);white-space:pre-wrap;padding:8px 12px}.sFkTnW_gitDiffTab{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;overflow:hidden auto}.sFkTnW_gitDiffTabHeader{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.sFkTnW_gitDiffTabTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.sFkTnW_producedRow{flex-wrap:wrap;align-items:center;gap:8px;padding:4px 0;display:flex}.sFkTnW_producedLabel{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}.sFkTnW_producedChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-width:200px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);cursor:pointer;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;display:inline-flex;overflow:hidden}.sFkTnW_producedChip:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_producedChip span{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.sFkTnW_producedMore{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}.sFkTnW_toggleButton:focus-visible,.sFkTnW_bottomClose:focus-visible,.sFkTnW_iconButton:focus-visible,.sFkTnW_tab:focus-visible,.sFkTnW_tabClose:focus-visible,.sFkTnW_tabBarPlus:focus-visible,.sFkTnW_paneCard:focus-visible,.sFkTnW_explorerRow:focus-visible,.sFkTnW_explorerRef:focus-visible,.sFkTnW_terminalRetry:focus-visible,.sFkTnW_editorModeButton:focus-visible,.sFkTnW_editorDownloadLink:focus-visible,.sFkTnW_editorPptxButton:focus-visible,.sFkTnW_editorDocxZoomRange:focus-visible{outline:2px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}@media (prefers-reduced-motion:reduce){.sFkTnW_panel,.sFkTnW_panelHidden,.sFkTnW_bottomPanel,.sFkTnW_bottomPanelHidden,.sFkTnW_toggleCluster,.sFkTnW_toggleButton,.sFkTnW_tab,.sFkTnW_tabBarPlus,.sFkTnW_paneCard,.sFkTnW_explorerRow,.sFkTnW_divider,.sFkTnW_dividerRow:after,.sFkTnW_dividerCol:after{transition:none;animation:none}}@media (width<=767px){.sFkTnW_panel:not(.sFkTnW_panelHidden) .sFkTnW_tabBar{padding-right:40px}.sFkTnW_tab{min-width:48px;max-width:128px}}.sFkTnW_openWithLabel{align-items:center;gap:8px;width:100%;min-width:0;display:flex}.sFkTnW_openWithName{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.sFkTnW_openWithChevron{color:var(--dsw-alias-label-tertiary);flex:none}.sFkTnW_openWithPin{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);cursor:pointer;border-radius:5px;flex:none;justify-content:center;align-items:center;display:inline-flex}.sFkTnW_openWithPin:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_openWithPinActive{color:var(--dsw-alias-state-business-primary)}.sFkTnW_editorHtmlBlock{margin:8px 0}.sFkTnW_editorHtmlBlock img,.sFkTnW_editorHtmlBlock video{max-width:100%}.sFkTnW_editorHtmlBlock details{margin:4px 0;padding:4px 0}.sFkTnW_editorHtmlBlock summary{cursor:pointer}.sFkTnW_tocBar{z-index:7;pointer-events:none;justify-content:flex-end;height:0;display:flex;position:sticky;top:0}.sFkTnW_tocButton{pointer-events:auto;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);width:26px;height:26px;color:var(--dsw-alias-label-secondary);cursor:pointer;border-radius:6px;justify-content:center;align-items:center;margin:4px 2px 0 0;padding:0;display:inline-flex}.sFkTnW_tocButton:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_tocPanel{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);width:min(300px,82%);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);pointer-events:auto;border-radius:8px;flex-direction:column;padding:4px;display:flex;position:absolute;top:32px;right:2px;overflow-y:auto}.sFkTnW_tocItem{min-width:0;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;align-items:baseline;gap:8px;padding:4px 8px;display:flex}.sFkTnW_tocItem:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sFkTnW_tocItem[data-level=\"2\"]{padding-left:18px}.sFkTnW_tocItem[data-level=\"3\"]{padding-left:28px}.sFkTnW_tocItem[data-level=\"4\"]{padding-left:38px}.sFkTnW_tocItem[data-level=\"5\"]{padding-left:48px}.sFkTnW_tocItem[data-level=\"6\"]{padding-left:58px}.sFkTnW_tocItemLevel{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}.sFkTnW_tocItemText{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}@keyframes sFkTnW_dsh-toc-flash{0%,60%{background:var(--dsw-alias-interactive-bg-hover)}to{background:0 0}}.sFkTnW_tocFlash{border-radius:4px;animation:1.2s ease-out sFkTnW_dsh-toc-flash}";
		...
		var sidebar_module_css_default = {
			"bottomResizeActive": "sFkTnW_bottomResizeActive",
			"editorModeToggle": "sFkTnW_editorModeToggle",
			"mermaidWrap": "sFkTnW_mermaidWrap",
			"mermaidModalButton": "sFkTnW_mermaidModalButton",
			"tabBoundaryError": "sFkTnW_tabBoundaryError",
			"openWithName": "sFkTnW_openWithName",
			"explorerConfirmDesc": "sFkTnW_explorerConfirmDesc",
			"terminalDepsActions": "sFkTnW_terminalDepsActions",
			"panelResizeActive": "sFkTnW_panelResizeActive",
			"terminalDepsBanner": "sFkTnW_terminalDepsBanner",
			"floatDropHintLabel": "sFkTnW_floatDropHintLabel",
			"paneEmptyCards": "sFkTnW_paneEmptyCards",
			"pane": "sFkTnW_pane",
			"floatResize": "sFkTnW_floatResize",
			"explorerRenameInput": "sFkTnW_explorerRenameInput",
			"uploadDropZonePill": "sFkTnW_uploadDropZonePill",
			"editorModeActive": "sFkTnW_editorModeActive",
			"sandboxAction": "sFkTnW_sandboxAction",
			"producedMore": "sFkTnW_producedMore",
			"gitDiffTab": "sFkTnW_gitDiffTab",
			"editorCm": "sFkTnW_editorCm",
			"uploadOverlayCancel": "sFkTnW_uploadOverlayCancel",
			"tocPanel": "sFkTnW_tocPanel",
			"uploadOverlayProgressFill": "sFkTnW_uploadOverlayProgressFill",
			"editorPdfDragShieldActive": "sFkTnW_editorPdfDragShieldActive",
			"editorMain": "sFkTnW_editorMain",
			"pinnedTab": "sFkTnW_pinnedTab",
			"floatHeader": "sFkTnW_floatHeader",
			"boundaryError": "sFkTnW_boundaryError",
			"tocButton": "sFkTnW_tocButton",
			"uploadOverlayProgress": "sFkTnW_uploadOverlayProgress",
			"explorerActionErrorText": "sFkTnW_explorerActionErrorText",
			"browserFrame": "sFkTnW_browserFrame",
			"editorBody": "sFkTnW_editorBody",
			"editorTreeDock": "sFkTnW_editorTreeDock",
			"orphanedType": "sFkTnW_orphanedType",
			"sandboxStatusText": "sFkTnW_sandboxStatusText",
			"tocItemLevel": "sFkTnW_tocItemLevel",
			"explorerRow": "sFkTnW_explorerRow",
			"toggleCluster": "sFkTnW_toggleCluster",
			"explorerActionError": "sFkTnW_explorerActionError",
			"bottomPanelHidden": "sFkTnW_bottomPanelHidden",
			"explorerBroken": "sFkTnW_explorerBroken",
			"editorStatus": "sFkTnW_editorStatus",
			"editorTreePanelFull": "sFkTnW_editorTreePanelFull",
			"explorerHeader": "sFkTnW_explorerHeader",
			"uploadOverlayTitle": "sFkTnW_uploadOverlayTitle",
			"browser": "sFkTnW_browser",
			"panel": "sFkTnW_panel",
			"dividerCol": "sFkTnW_dividerCol",
			"editorPdfFrame": "sFkTnW_editorPdfFrame",
			"editorPdfDragShield": "sFkTnW_editorPdfDragShield",
			"floatWindowDragging": "sFkTnW_floatWindowDragging",
			"floatClose": "sFkTnW_floatClose",
			"terminalRepairCommand": "sFkTnW_terminalRepairCommand",
			"workbench": "sFkTnW_workbench",
			"bottomPanel": "sFkTnW_bottomPanel",
			"bottomClose": "sFkTnW_bottomClose",
			"editorDownloadLink": "sFkTnW_editorDownloadLink",
			"uploadDropChatHint": "sFkTnW_uploadDropChatHint",
			"explorer": "sFkTnW_explorer",
			"terminal": "sFkTnW_terminal",
			"terminalDepsHint": "sFkTnW_terminalDepsHint",
			"dropLeft": "sFkTnW_dropLeft",
			"dropDown": "sFkTnW_dropDown",
			"explorerDir": "sFkTnW_explorerDir",
			"editorTitle": "sFkTnW_editorTitle",
			"cornerHandle": "sFkTnW_cornerHandle",
			"editorPptxButton": "sFkTnW_editorPptxButton",
			"editorPdfToolbar": "sFkTnW_editorPdfToolbar",
			"editorHtmlBlock": "sFkTnW_editorHtmlBlock",
			"uploadDropZone": "sFkTnW_uploadDropZone",
			"uploadOverlay": "sFkTnW_uploadOverlay",
			"explorerRoot": "sFkTnW_explorerRoot",
			"explorerName": "sFkTnW_explorerName",
			"mermaidInfo": "sFkTnW_mermaidInfo",
			"iconButton": "sFkTnW_iconButton",
			"floatContent": "sFkTnW_floatContent",
			"mermaidBody": "sFkTnW_mermaidBody",
			"uploadDropZoneText": "sFkTnW_uploadDropZoneText",
			"paneDrop": "sFkTnW_paneDrop",
			"uploadDropChatCard": "sFkTnW_uploadDropChatCard",
			"editorError": "sFkTnW_editorError",
			"editorImageWrap": "sFkTnW_editorImageWrap",
			"editorStatusError": "sFkTnW_editorStatusError",
			"editorBinaryNotice": "sFkTnW_editorBinaryNotice",
			"editorImage": "sFkTnW_editorImage",
			"editorPdfFrameBlocked": "sFkTnW_editorPdfFrameBlocked",
			"terminalDepsCommandRow": "sFkTnW_terminalDepsCommandRow",
			"openWithPinActive": "sFkTnW_openWithPinActive",
			"gitDiffTabHeader": "sFkTnW_gitDiffTabHeader",
			"editorHeader": "sFkTnW_editorHeader",
			"terminalBannerUrl": "sFkTnW_terminalBannerUrl",
			"mermaidModalStage": "sFkTnW_mermaidModalStage",
			"dropRight": "sFkTnW_dropRight",
			"mermaidError": "sFkTnW_mermaidError",
			"editorTreeSearch": "sFkTnW_editorTreeSearch",
			"tabClose": "sFkTnW_tabClose",
			"dropOverlay": "sFkTnW_dropOverlay",
			"paneTab": "sFkTnW_paneTab",
			"tabList": "sFkTnW_tabList",
			"tabActive": "sFkTnW_tabActive",
			"explorerEmpty": "sFkTnW_explorerEmpty",
			"mermaidHeader": "sFkTnW_mermaidHeader",
			"gitDiffTabTitle": "sFkTnW_gitDiffTabTitle",
			"openWithChevron": "sFkTnW_openWithChevron",
			"tabTitle": "sFkTnW_tabTitle",
			"mermaidModalToolbar": "sFkTnW_mermaidModalToolbar",
			"splitChild": "sFkTnW_splitChild",
			"explorerRenaming": "sFkTnW_explorerRenaming",
			"paneTabHidden": "sFkTnW_paneTabHidden",
			"editorCmHidden": "sFkTnW_editorCmHidden",
			"editorHtml": "sFkTnW_editorHtml",
			"mermaidCode": "sFkTnW_mermaidCode",
			"selectionPopup": "sFkTnW_selectionPopup",
			"tocItem": "sFkTnW_tocItem",
			"panelResize": "sFkTnW_panelResize",
			"browserInput": "sFkTnW_browserInput",
			"dividerActive": "sFkTnW_dividerActive",
			"editorTreeResize": "sFkTnW_editorTreeResize",
			"mermaidModal": "sFkTnW_mermaidModal",
			"mermaidCopy": "sFkTnW_mermaidCopy",
			"dsh-toc-flash": "sFkTnW_dsh-toc-flash",
			"explorerActionErrorClose": "sFkTnW_explorerActionErrorClose",
			"editorDocxZoomRange": "sFkTnW_editorDocxZoomRange",
			"browserBlocked": "sFkTnW_browserBlocked",
			"uploadOverlayStatus": "sFkTnW_uploadOverlayStatus",
			"tocBar": "sFkTnW_tocBar",
			"splitCol": "sFkTnW_splitCol",
			"editorSearchResult": "sFkTnW_editorSearchResult",
			"editorPdf": "sFkTnW_editorPdf",
			"tocItemText": "sFkTnW_tocItemText",
			"tocFlash": "sFkTnW_tocFlash",
			"dropCenter": "sFkTnW_dropCenter",
			"uploadOverlayCard": "sFkTnW_uploadOverlayCard",
			"dirtyDot": "sFkTnW_dirtyDot",
			"editorPlaceholder": "sFkTnW_editorPlaceholder",
			"explorerSymlink": "sFkTnW_explorerSymlink",
			"mermaidModalHint": "sFkTnW_mermaidModalHint",
			"browserBlockedButton": "sFkTnW_browserBlockedButton",
			"editorBinary": "sFkTnW_editorBinary",
			"terminalWrap": "sFkTnW_terminalWrap",
			"paneContent": "sFkTnW_paneContent",
			"browserMessage": "sFkTnW_browserMessage",
			"browserStart": "sFkTnW_browserStart",
			"gitError": "sFkTnW_gitError",
			"explorerRowDropTarget": "sFkTnW_explorerRowDropTarget",
			"producedChip": "sFkTnW_producedChip",
			"paneCard": "sFkTnW_paneCard",
			"explorerError": "sFkTnW_explorerError",
			"tabBadge": "sFkTnW_tabBadge",
			"sandboxStatus": "sFkTnW_sandboxStatus",
			"openWithLabel": "sFkTnW_openWithLabel",
			"terminalDepsTitle": "sFkTnW_terminalDepsTitle",
			"browserBar": "sFkTnW_browserBar",
			"editorTreePanel": "sFkTnW_editorTreePanel",
			"editorPdfStage": "sFkTnW_editorPdfStage",
			"editorModeButton": "sFkTnW_editorModeButton",
			"floatWindow": "sFkTnW_floatWindow",
			"terminalBanner": "sFkTnW_terminalBanner",
			"editorPathInput": "sFkTnW_editorPathInput",
			"dropUp": "sFkTnW_dropUp",
			"mermaidMarkdown": "sFkTnW_mermaidMarkdown",
			"producedLabel": "sFkTnW_producedLabel",
			"sandboxStatusOff": "sFkTnW_sandboxStatusOff",
			"dividerRow": "sFkTnW_dividerRow",
			"editorMd": "sFkTnW_editorMd",
			"gitEmpty": "sFkTnW_gitEmpty",
			"editor": "sFkTnW_editor",
			"split": "sFkTnW_split",
			"explorerBody": "sFkTnW_explorerBody",
			"fenceError": "sFkTnW_fenceError",
			"panelBody": "sFkTnW_panelBody",
			"terminalDepsNote": "sFkTnW_terminalDepsNote",
			"splitRow": "sFkTnW_splitRow",
			"uploadDropHero": "sFkTnW_uploadDropHero",
			"openWithPin": "sFkTnW_openWithPin",
			"browserBlockedDesc": "sFkTnW_browserBlockedDesc",
			"floatTitle": "sFkTnW_floatTitle",
			"tab": "sFkTnW_tab",
			"divider": "sFkTnW_divider",
			"dsh-row-in": "sFkTnW_dsh-row-in",
			"explorerRowRevealed": "sFkTnW_explorerRowRevealed",
			"tabBar": "sFkTnW_tabBar",
			"tabBarPlus": "sFkTnW_tabBarPlus",
			"tabBarDrop": "sFkTnW_tabBarDrop",
			"browserBlockedTitle": "sFkTnW_browserBlockedTitle",
			"browserBlockedActions": "sFkTnW_browserBlockedActions",
			"producedRow": "sFkTnW_producedRow",
			"explorerCopied": "sFkTnW_explorerCopied",
			"explorerHidden": "sFkTnW_explorerHidden",
			"terminalRetry": "sFkTnW_terminalRetry",
			"editorSearchInput": "sFkTnW_editorSearchInput",
			"floatDropHint": "sFkTnW_floatDropHint",
			"panelHidden": "sFkTnW_panelHidden",
			"explorerRef": "sFkTnW_explorerRef",
			"sandboxStatusOn": "sFkTnW_sandboxStatusOn",
			"sandboxDot": "sFkTnW_sandboxDot",
			"editorSearchHint": "sFkTnW_editorSearchHint",
			"gitPlaceholder": "sFkTnW_gitPlaceholder",
			"editorTreeToggleActive": "sFkTnW_editorTreeToggleActive",
			"toggleButton": "sFkTnW_toggleButton",
			"bottomResize": "sFkTnW_bottomResize",
			"editorBanner": "sFkTnW_editorBanner"
		};
		//#endregion
		...
		*/
		function parsePrefs(value) {
			...
			return {
				...
				hotkeyToggleTarget: isHotkeyToggleTarget(record.hotkeyToggleTarget) ? record.hotkeyToggleTarget : SIDEBAR_PREFS_DEFAULTS.hotkeyToggleTarget,
		...
		*/
		...
		function isHotkeyToggleTarget(value) {
			return typeof value === "string" && HOTKEY_TOGGLE_TARGETS.includes(value);
		}
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jkw/Documents/dshspace/plugins/dsh-better-sidebar/src/client/SideCardSection.module.css.mjs
		const css$5 = ".KTBu6a_section{flex-direction:column;gap:16px;width:100%;max-width:760px;display:flex}.KTBu6a_intro{color:var(--dsw-alias-label-tertiary);margin:0;padding:0 2px;font-size:13px;line-height:20px}.KTBu6a_group{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:16px;flex-direction:column;flex:none;gap:8px;padding:20px;display:flex}.KTBu6a_groupHeading{color:var(--dsw-alias-label-primary);align-items:baseline;gap:7px;padding:0 2px 6px;font-size:13px;font-weight:600;line-height:20px;display:flex}.KTBu6a_count{background:var(--dsw-alias-accent-soft,var(--dsw-alias-bg-layer-2));color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:16px}.KTBu6a_grid{grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:12px;display:grid}.KTBu6a_card{border:1px solid var(--dsw-alias-border-l2);min-height:106px;font:inherit;color:inherit;cursor:pointer;background:0 0;border-radius:12px;flex-direction:column;transition:background .12s,border-color .12s;display:flex;position:relative;overflow:hidden}.KTBu6a_card:not(.KTBu6a_cardOn):hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-label-dimmed)}.KTBu6a_cardOn{border-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 45%, transparent);background:var(--dsw-alias-interactive-bg-active)}.KTBu6a_cardMain{border-radius:inherit;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex-direction:column;flex:1;gap:6px;padding:12px;display:flex}.KTBu6a_cardMain:focus-visible,.KTBu6a_cardSettings:focus-visible,.KTBu6a_rowGear:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:2px}.KTBu6a_cardTop{align-items:center;gap:8px;min-width:0;min-height:28px;display:flex}.KTBu6a_cardIconChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);width:28px;height:28px;color:var(--dsw-alias-label-tertiary);border-radius:8px;flex:none;justify-content:center;align-items:center;display:inline-flex}.KTBu6a_cardOn .KTBu6a_cardIconChip{border-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 35%, transparent);background:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 12%, transparent);color:var(--dsw-alias-button-primary-fill)}.KTBu6a_cardTitle{min-width:0;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;flex:1;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.KTBu6a_cardOn .KTBu6a_cardTitle{color:var(--dsw-alias-label-primary)}.KTBu6a_cardSwitch{flex:none;align-items:center;display:inline-flex}.KTBu6a_cardSwitchTrack{box-sizing:border-box;background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:8px;align-items:center;width:30px;height:16px;padding:2px;transition:background .15s,border-color .15s;display:inline-flex}.KTBu6a_cardSwitchThumb{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:10px;height:10px;transition:transform .15s,background .15s;display:block}.KTBu6a_cardOn .KTBu6a_cardSwitchTrack{border-color:var(--dsw-alias-button-primary-fill);background:var(--dsw-alias-button-primary-fill)}.KTBu6a_cardOn .KTBu6a_cardSwitchThumb{background:var(--dsw-alias-bg-layer-3);transform:translate(14px)}.KTBu6a_cardDesc{color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;font-size:11px;line-height:16px;overflow:hidden}.KTBu6a_addCard{border-style:dashed;border-color:var(--dsw-alias-border-l2);text-align:left;align-items:flex-start;padding:12px}.KTBu6a_addCard:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}.KTBu6a_addCard:hover .KTBu6a_cardTitle{color:var(--dsw-alias-label-primary)}.KTBu6a_addCard:hover .KTBu6a_cardIconChip{border-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 35%, transparent);color:var(--dsw-alias-button-primary-fill)}.KTBu6a_addCard:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:2px}.KTBu6a_cardOn .KTBu6a_cardDesc{color:var(--dsw-alias-label-secondary)}.KTBu6a_cardSettings{border:0;border-top:1px solid var(--dsw-alias-border-l1);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;cursor:pointer;background:0 0;align-items:center;gap:6px;padding:6px 12px;font-size:11px;font-weight:500;line-height:16px;transition:background .12s,color .12s;display:flex}.KTBu6a_cardOn .KTBu6a_cardSettings{border-top-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 18%, transparent)}.KTBu6a_cardSettings:hover{background:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-brand-primary)}.KTBu6a_rowGear{border:1px solid var(--dsw-alias-border-l2);width:22px;height:22px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;transition:background .12s,border-color .12s,color .12s;display:inline-flex}.KTBu6a_rowGear:hover{border-color:var(--dsw-alias-interactive-bg-hover-accent);background:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-brand-primary)}.KTBu6a_row{border-bottom:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:16px;padding:12px 2px;display:flex}.KTBu6a_row:last-child{border-bottom:none}.KTBu6a_rowText{flex-direction:column;gap:4px;min-width:0;display:flex}.KTBu6a_title{color:var(--dsw-alias-label-primary);font-size:14px;line-height:22px}.KTBu6a_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.KTBu6a_switch{cursor:pointer;flex:none;display:inline-flex;position:relative}.KTBu6a_switchInput{opacity:0;width:1px;height:1px;margin:0;position:absolute}.KTBu6a_switchTrack{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:10px;align-items:center;width:36px;height:20px;padding:2px;transition:background .15s,border-color .15s;display:inline-flex}.KTBu6a_switchThumb{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:14px;height:14px;transition:transform .15s,background .15s;display:block}.KTBu6a_switch:hover .KTBu6a_switchTrack{border-color:var(--dsw-alias-label-dimmed)}.KTBu6a_switchInput:checked+.KTBu6a_switchTrack{border-color:var(--dsw-alias-button-primary-fill);background:var(--dsw-alias-button-primary-fill)}.KTBu6a_switchInput:checked+.KTBu6a_switchTrack .KTBu6a_switchThumb{background:var(--dsw-alias-bg-layer-3);transform:translate(16px)}.KTBu6a_switchInput:focus-visible+.KTBu6a_switchTrack{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.KTBu6a_control{flex:none;align-items:center;gap:6px;display:flex}.KTBu6a_percentInput{width:76px}.KTBu6a_typedInput{width:200px}.KTBu6a_typedInputNumber{width:76px}.KTBu6a_selectAnchor{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);max-width:220px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:8px;align-items:center;gap:6px;padding:4px 8px;font-size:13px;line-height:20px;display:flex}.KTBu6a_selectAnchor:hover{border-color:var(--dsw-alias-label-dimmed)}.KTBu6a_selectAnchorIcon{flex:none;display:inline-flex}.KTBu6a_selectAnchorText{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.KTBu6a_selectOption{align-items:center;gap:10px;min-width:200px;display:flex}.KTBu6a_selectOptionIcon{color:var(--dsw-alias-label-secondary);flex:none;display:inline-flex}.KTBu6a_selectOptionText{flex-direction:column;min-width:0;display:flex}.KTBu6a_suffix{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}.KTBu6a_cssTextArea{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);width:100%;min-height:120px;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,monospace);resize:vertical;border-radius:8px;padding:8px 10px;font-size:12px;line-height:1.6}.KTBu6a_cssTextArea:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.KTBu6a_popupDialog.KTBu6a_popupDialog{width:min(460px,100%)}.KTBu6a_popupRows{box-sizing:border-box;scrollbar-width:thin;scrollbar-color:var(--dsw-alias-scrollbar-bg-l2,transparent) transparent;flex-direction:column;gap:8px;width:100%;max-height:min(52vh,440px);padding-right:4px;display:flex;overflow:hidden auto}.KTBu6a_popupRows::-webkit-scrollbar{width:6px}.KTBu6a_popupRows::-webkit-scrollbar-thumb{background:var(--dsw-alias-scrollbar-bg-l2,var(--dsw-alias-border-l2));border-radius:3px}.KTBu6a_popupRows::-webkit-scrollbar-thumb:hover{background:var(--dsw-alias-scrollbar-hover-l2,var(--dsw-alias-label-dimmed))}.KTBu6a_popupRow{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex:none;justify-content:space-between;align-items:center;gap:16px;min-width:0;padding:12px 14px;transition:border-color .16s,background .16s;display:flex}.KTBu6a_popupRow:hover{border-color:var(--dsw-alias-label-dimmed)}.KTBu6a_done{appearance:none;font:inherit;cursor:pointer;background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.KTBu6a_done:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}.KTBu6a_error{color:var(--dsw-alias-state-error-primary);padding:10px 0 2px;font-size:12px;line-height:17px}.KTBu6a_pluginModal.KTBu6a_pluginModal{width:min(560px,100%)}.KTBu6a_pluginList{flex-direction:column;gap:12px;width:100%;display:flex}.KTBu6a_pluginTopicBtn{appearance:none;border:1px solid var(--dsw-alias-border-l2);width:100%;font:inherit;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);cursor:pointer;border-radius:8px;padding:6px 12px;font-size:12px;line-height:18px}.KTBu6a_pluginTopicBtn:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}.KTBu6a_pluginTopicBtn:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:1px}.KTBu6a_pluginEmpty{color:var(--dsw-alias-label-tertiary);padding:20px 2px;font-size:12px;line-height:18px}.KTBu6a_pluginEntry{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:12px;flex-direction:column;gap:4px;padding:12px;display:flex}.KTBu6a_pluginEntryHead{justify-content:space-between;align-items:center;gap:12px;display:flex}.KTBu6a_pluginEntryActions{flex:none;align-items:center;gap:6px;display:inline-flex}.KTBu6a_pluginJumpBtn{appearance:none;border:1px solid var(--dsw-alias-border-l2);font:inherit;cursor:pointer;color:var(--dsw-alias-label-secondary);background:0 0;border-radius:8px;flex:none;padding:3px 12px;font-size:12px;line-height:1.5}.KTBu6a_pluginJumpBtn:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}.KTBu6a_pluginJumpBtn:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:1px}.KTBu6a_pluginName{appearance:none;min-width:0;font:inherit;color:var(--dsw-alias-label-primary);text-align:left;text-overflow:ellipsis;white-space:nowrap;cursor:pointer;background:0 0;border:0;padding:0;font-size:13px;font-weight:600;line-height:20px;text-decoration:none;overflow:hidden}.KTBu6a_pluginName:hover{color:var(--dsw-alias-button-primary-fill);text-decoration:underline}.KTBu6a_pluginDesc{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}.KTBu6a_pluginInstall{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l1);white-space:nowrap;border-radius:8px;padding:6px 10px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;line-height:16px;display:block;overflow-x:auto}.KTBu6a_pluginCopyBtn{appearance:none;font:inherit;cursor:pointer;background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);border:1px solid #0000;border-radius:8px;flex:none;padding:3px 12px;font-size:12px;line-height:1.5}.KTBu6a_pluginCopyBtn:hover{background:var(--dsw-alias-button-primary-hover)}.KTBu6a_pluginCopyBtn:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}@media (prefers-reduced-motion:reduce){.KTBu6a_card,.KTBu6a_cardSettings,.KTBu6a_cardSwitchTrack,.KTBu6a_cardSwitchThumb,.KTBu6a_rowGear,.KTBu6a_popupRow,.KTBu6a_switchTrack,.KTBu6a_switchThumb{transition:none}}.KTBu6a_versionBadge{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:999px;align-self:flex-start;align-items:center;gap:8px;padding:4px 12px 4px 14px;font-size:12px;line-height:18px;display:inline-flex}.KTBu6a_versionBadgeName{color:var(--dsw-alias-label-primary);font-weight:600}.KTBu6a_versionBadgeTag{background:var(--dsw-alias-accent-soft,var(--dsw-alias-border-l2));color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;border-radius:999px;padding:1px 8px}.KTBu6a_pluginSearch{box-sizing:border-box;appearance:none;border:1px solid var(--dsw-alias-border-l2);width:100%;font:inherit;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);border-radius:8px;padding:6px 10px;font-size:12px;line-height:18px}.KTBu6a_pluginSearch::placeholder{color:var(--dsw-alias-label-tertiary)}.KTBu6a_pluginSearch:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:1px}.KTBu6a_pluginEntries{flex-direction:column;gap:10px;max-height:46vh;padding-right:2px;display:flex;overflow:hidden auto}.KTBu6a_pluginGroup{flex-direction:column;gap:8px;display:flex}.KTBu6a_pluginGroupHeading{color:var(--dsw-alias-label-secondary);padding:2px 2px 0;font-size:12px;font-weight:600;line-height:18px}.KTBu6a_openWithEditorRow{grid-template-columns:1fr 1.5fr auto auto;align-items:center;gap:8px;min-width:0;display:grid}.KTBu6a_openWithEditorInput,.KTBu6a_openWithEditorTemplate{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:inherit;border-radius:8px;padding:5px 8px;font-size:13px;line-height:20px}.KTBu6a_openWithEditorInput:focus-visible,.KTBu6a_openWithEditorTemplate:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.KTBu6a_openWithFamily{color:var(--dsw-alias-label-secondary);white-space:nowrap;cursor:pointer;align-items:center;gap:5px;font-size:12px;display:inline-flex}.KTBu6a_openWithRemove{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:8px;justify-content:center;align-items:center;padding:4px;display:inline-flex}.KTBu6a_openWithRemove:hover{color:var(--dsw-alias-state-error-primary);background:var(--dsw-alias-bg-layer-2)}.KTBu6a_openWithHint{color:var(--dsw-alias-state-error-primary);padding:0 2px;font-size:12px;line-height:17px}";
		...
		var SideCardSection_module_css_default = {
			"count": "KTBu6a_count",
			"cardIconChip": "KTBu6a_cardIconChip",
			"versionBadgeTag": "KTBu6a_versionBadgeTag",
			"pluginGroup": "KTBu6a_pluginGroup",
			"openWithEditorRow": "KTBu6a_openWithEditorRow",
			"versionBadge": "KTBu6a_versionBadge",
			"openWithEditorInput": "KTBu6a_openWithEditorInput",
			"openWithFamily": "KTBu6a_openWithFamily",
			"cardOn": "KTBu6a_cardOn",
			"cardTitle": "KTBu6a_cardTitle",
			"cardTop": "KTBu6a_cardTop",
			"pluginInstall": "KTBu6a_pluginInstall",
			"switchTrack": "KTBu6a_switchTrack",
			"pluginEntry": "KTBu6a_pluginEntry",
			"pluginEmpty": "KTBu6a_pluginEmpty",
			"pluginEntries": "KTBu6a_pluginEntries",
			"group": "KTBu6a_group",
			"popupDialog": "KTBu6a_popupDialog",
			"versionBadgeName": "KTBu6a_versionBadgeName",
			"cssTextArea": "KTBu6a_cssTextArea",
			"groupHeading": "KTBu6a_groupHeading",
			"selectAnchor": "KTBu6a_selectAnchor",
			"cardDesc": "KTBu6a_cardDesc",
			"cardSwitchThumb": "KTBu6a_cardSwitchThumb",
			"grid": "KTBu6a_grid",
			"pluginModal": "KTBu6a_pluginModal",
			"intro": "KTBu6a_intro",
			"section": "KTBu6a_section",
			"pluginName": "KTBu6a_pluginName",
			"selectOption": "KTBu6a_selectOption",
			"popupRow": "KTBu6a_popupRow",
			"percentInput": "KTBu6a_percentInput",
			"pluginEntryActions": "KTBu6a_pluginEntryActions",
			"suffix": "KTBu6a_suffix",
			"openWithRemove": "KTBu6a_openWithRemove",
			"openWithHint": "KTBu6a_openWithHint",
			"switchThumb": "KTBu6a_switchThumb",
			"switch": "KTBu6a_switch",
			"selectOptionIcon": "KTBu6a_selectOptionIcon",
			"selectOptionText": "KTBu6a_selectOptionText",
			"pluginSearch": "KTBu6a_pluginSearch",
			"pluginTopicBtn": "KTBu6a_pluginTopicBtn",
			"selectAnchorText": "KTBu6a_selectAnchorText",
			"done": "KTBu6a_done",
			"pluginList": "KTBu6a_pluginList",
			"pluginJumpBtn": "KTBu6a_pluginJumpBtn",
			"rowText": "KTBu6a_rowText",
			"pluginCopyBtn": "KTBu6a_pluginCopyBtn",
			"pluginGroupHeading": "KTBu6a_pluginGroupHeading",
			"pluginEntryHead": "KTBu6a_pluginEntryHead",
			"rowGear": "KTBu6a_rowGear",
			"title": "KTBu6a_title",
			"error": "KTBu6a_error",
			"control": "KTBu6a_control",
			"switchInput": "KTBu6a_switchInput",
			"typedInputNumber": "KTBu6a_typedInputNumber",
			"cardSwitch": "KTBu6a_cardSwitch",
			"cardSettings": "KTBu6a_cardSettings",
			"cardMain": "KTBu6a_cardMain",
			"desc": "KTBu6a_desc",
			"popupRows": "KTBu6a_popupRows",
			"row": "KTBu6a_row",
			"addCard": "KTBu6a_addCard",
			"openWithEditorTemplate": "KTBu6a_openWithEditorTemplate",
			"pluginDesc": "KTBu6a_pluginDesc",
			"cardSwitchTrack": "KTBu6a_cardSwitchTrack",
			"selectAnchorIcon": "KTBu6a_selectAnchorIcon",
			"card": "KTBu6a_card",
			"typedInput": "KTBu6a_typedInput"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jkw/Documents/dshspace/plugins/dsh-better-sidebar/src/client/changes/changes.module.css.mjs
		const css$4 = ".JxZQAa_root{background:var(--dsw-alias-bg-base);height:100%;min-height:0;color:var(--dsw-alias-label-primary);flex-direction:column;font-size:12px;display:flex}.JxZQAa_lensBar{flex:none;align-items:center;padding:8px 8px 4px 12px;display:flex}.JxZQAa_lensSwitch{border:1px solid var(--dsw-alias-border-l2);border-radius:8px;gap:2px;padding:2px;display:inline-flex}.JxZQAa_lensButton{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;background:0 0;border:0;border-radius:6px;padding:2px 10px}.JxZQAa_lensButton:hover{color:var(--dsw-alias-label-primary)}.JxZQAa_lensButton[data-active=true]{background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-label-primary)}.JxZQAa_git{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;overflow:hidden auto}.JxZQAa_gitHeader{flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.JxZQAa_gitWorktreeRow{flex:none;align-items:center;gap:8px;padding:6px 8px 0 12px;display:flex}.JxZQAa_gitWorktreeLabel{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-11);flex:none}.JxZQAa_gitBranchSelect{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 6px}.JxZQAa_gitSection{border-top:1px solid var(--dsw-alias-border-l1)}.JxZQAa_gitSectionHeader{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary);text-transform:uppercase;justify-content:space-between;align-items:center;padding:6px 12px 4px;display:flex}.JxZQAa_gitLink{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-brand-primary);cursor:pointer;background:0 0;border:none;padding:0}.JxZQAa_gitLink:hover:not(:disabled){text-decoration:underline}.JxZQAa_gitLink:disabled{opacity:.4;cursor:default}.JxZQAa_gitRow{min-height:34px;animation:JxZQAa_dsh-row-in .15s var(--ds-ease-in-out);border-radius:8px;align-items:center;gap:6px;margin:0 6px;padding:0 8px;display:flex}.JxZQAa_gitRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.JxZQAa_gitRow[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.JxZQAa_gitRowMain{cursor:pointer;text-align:left;background:0 0;border:none;flex:1;align-items:center;gap:8px;min-width:0;padding:3px 0;display:flex}.JxZQAa_gitBadge{width:20px;height:16px;font:var(--dsw-font-xxxs-strong-11);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;justify-content:center;align-items:center;display:inline-flex}.JxZQAa_gitBadge[data-letter=A],.JxZQAa_gitBadge[data-letter=\\?]{color:var(--dsw-alias-state-success-primary)}.JxZQAa_gitBadge[data-letter=D]{color:var(--dsw-alias-state-error-primary)}.JxZQAa_gitBadge[data-letter=M],.JxZQAa_gitBadge[data-letter=R]{color:var(--dsw-alias-state-business-primary)}.JxZQAa_gitBadge[data-letter=C],.JxZQAa_gitBadge[data-letter=U]{color:var(--dsw-alias-state-warn-primary)}.JxZQAa_gitName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.JxZQAa_gitEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);padding:4px 12px 8px}.JxZQAa_gitPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}.JxZQAa_gitError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);white-space:pre-wrap;padding:8px 12px}.JxZQAa_gitConfirmDesc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);white-space:pre-wrap;margin:0}.JxZQAa_gitCommit{border-top:1px solid var(--dsw-alias-border-l1);align-items:center;gap:6px;padding:8px 12px;display:flex}.JxZQAa_gitCommitInput{flex:1;min-width:0}.JxZQAa_gitCommitButton{background:var(--dsw-alias-button-primary-fill);height:26px;color:var(--dsw-alias-label-primary-inverted);font:var(--dsw-font-xxs-strong-12);cursor:pointer;border:none;border-radius:6px;flex:none;padding:0 12px}.JxZQAa_gitCommitButton:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}.JxZQAa_gitCommitButton:disabled{opacity:.45;cursor:default}.JxZQAa_gitLogRow{cursor:pointer;border-radius:8px;flex-direction:column;gap:2px;padding:5px 12px;display:flex}.JxZQAa_gitLogRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.JxZQAa_gitLogRow[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.JxZQAa_gitLogLine1{align-items:baseline;gap:8px;min-width:0;display:flex}.JxZQAa_gitLogHash{font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-tertiary);flex:none}.JxZQAa_gitLogLine2{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;display:flex}.JxZQAa_gitLogRef{border:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-brand-primary);white-space:nowrap;border-radius:999px;flex:none;padding:0 5px}.JxZQAa_gitLogSubject{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.JxZQAa_gitLogMeta{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}.JxZQAa_gitLogMore{border:1px solid var(--dsw-alias-border-l2);width:calc(100% - 24px);font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:6px;margin:4px 12px 8px;padding:6px 0;display:block}.JxZQAa_gitLogMore:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.JxZQAa_gitLogMore:disabled{opacity:.5;cursor:default}.JxZQAa_session{flex-direction:column;flex:1;min-height:0;display:flex}.JxZQAa_filterRow{flex-wrap:wrap;flex:none;gap:4px;padding:2px 8px 6px 12px;display:flex}.JxZQAa_filterChip{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-11);cursor:pointer;background:0 0;border-radius:999px;padding:1px 8px}.JxZQAa_filterChip:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.JxZQAa_filterChip[data-active=true]{background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-label-primary);border-color:#0000}.JxZQAa_sessionList{flex:1;min-height:0;padding:0 6px 10px;overflow-y:auto}.JxZQAa_empty{color:var(--dsw-alias-label-tertiary);text-align:center;padding:24px 8px}.JxZQAa_loadError{border-left:3px solid var(--dsw-alias-state-warn-primary);color:var(--dsw-alias-label-secondary);border-radius:0 6px 6px 0;margin:4px 8px;padding:6px 10px;font-size:11px}.JxZQAa_fileGroup{margin-bottom:6px}.JxZQAa_filePath{color:var(--dsw-alias-label-tertiary);font-family:var(--ds-font-family-code,monospace);word-break:break-all;padding:6px 4px 2px;font-size:11px;display:block}.JxZQAa_fileGroup:first-child .JxZQAa_filePath{padding-top:2px}.JxZQAa_opRow{width:100%;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;text-align:left;background:0 0;border:0;border-radius:6px;align-items:center;gap:6px;padding:3px 5px;font-size:11px;display:flex}.JxZQAa_opRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.JxZQAa_opRow[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.JxZQAa_opRow[data-op-error=true]{box-shadow:inset 2px 0 0 var(--dsw-alias-state-error-primary)}.JxZQAa_opKind{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:10px;line-height:16px}.JxZQAa_opKind[data-kind=write]{color:var(--dsw-alias-state-success-primary)}.JxZQAa_opKind[data-kind=edit]{color:var(--dsw-alias-state-business-primary)}.JxZQAa_opMeta{flex:none;align-items:baseline;gap:8px;min-width:0;margin-left:auto;display:inline-flex}.JxZQAa_opTime{color:var(--dsw-alias-label-tertiary);flex:none;font-size:10px}.JxZQAa_opFlag{color:var(--dsw-alias-state-business-primary);flex:none;font-size:10px}.JxZQAa_opFlagError{color:var(--dsw-alias-state-error-primary);flex:none;font-size:10px}.JxZQAa_opSize{color:var(--dsw-alias-label-tertiary);font-size:10px;font-family:var(--ds-font-family-code,monospace);flex:none}.JxZQAa_diffPane{border-top:1px solid var(--dsw-alias-border-l1);flex-direction:column;flex:none;min-height:0;display:flex}.JxZQAa_dragHandle{cursor:ns-resize;background:var(--dsw-alias-bg-base);flex:none;height:8px;position:relative}.JxZQAa_dragHandle:after{content:\"\";background:var(--dsw-alias-border-l2);border-radius:1px;width:36px;height:2px;position:absolute;top:3px;left:calc(50% - 18px)}.JxZQAa_dragHandle:hover:after,.JxZQAa_dragHandle:focus-visible:after{background:var(--dsw-alias-state-business-primary)}.JxZQAa_diffHead{border-bottom:1px solid var(--dsw-alias-border-l1);align-items:center;gap:6px;padding:3px 8px 3px 10px;display:flex}.JxZQAa_diffKind{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:10px;line-height:16px}.JxZQAa_diffKind[data-kind=git]{color:var(--dsw-alias-brand-primary)}.JxZQAa_diffKind[data-kind=write]{color:var(--dsw-alias-state-success-primary)}.JxZQAa_diffKind[data-kind=edit]{color:var(--dsw-alias-state-business-primary)}.JxZQAa_diffPath{font-family:var(--ds-font-family-code,monospace);white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-primary);direction:rtl;flex:1;min-width:0;font-size:11px;overflow:hidden}.JxZQAa_diffStats{font-size:10px;font-family:var(--ds-font-family-code,monospace);flex:none;gap:5px;display:inline-flex}.JxZQAa_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.JxZQAa_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.JxZQAa_iconButton:disabled{opacity:.4;cursor:default}.JxZQAa_paneBody{flex:1;min-height:0;overflow-y:auto}.JxZQAa_readError{color:var(--dsw-alias-state-error-primary);border-left:3px solid var(--dsw-alias-state-error-primary);white-space:pre-wrap;word-break:break-word;border-radius:0 6px 6px 0;margin:6px 8px;padding:6px 10px}.JxZQAa_priorUnknown{color:var(--dsw-alias-label-tertiary);padding:3px 10px;font-size:10px}@keyframes JxZQAa_dsh-row-in{0%{opacity:0}}.JxZQAa_gitLink:focus-visible,.JxZQAa_gitRowMain:focus-visible,.JxZQAa_gitLogRow:focus-visible,.JxZQAa_gitCommitButton:focus-visible,.JxZQAa_gitLogMore:focus-visible,.JxZQAa_gitBranchSelect:focus-visible,.JxZQAa_lensButton:focus-visible,.JxZQAa_filterChip:focus-visible,.JxZQAa_iconButton:focus-visible,.JxZQAa_dragHandle:focus-visible{outline:2px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}@media (prefers-reduced-motion:reduce){.JxZQAa_gitRow{animation:none}}";
		...
		var changes_module_css_default = {
			"opSize": "JxZQAa_opSize",
			"diffPath": "JxZQAa_diffPath",
			"paneBody": "JxZQAa_paneBody",
			"gitCommit": "JxZQAa_gitCommit",
			"lensButton": "JxZQAa_lensButton",
			"gitLogMore": "JxZQAa_gitLogMore",
			"gitSectionHeader": "JxZQAa_gitSectionHeader",
			"gitRow": "JxZQAa_gitRow",
			"opMeta": "JxZQAa_opMeta",
			"diffKind": "JxZQAa_diffKind",
			"gitLogSubject": "JxZQAa_gitLogSubject",
			"gitWorktreeLabel": "JxZQAa_gitWorktreeLabel",
			"lensSwitch": "JxZQAa_lensSwitch",
			"gitConfirmDesc": "JxZQAa_gitConfirmDesc",
			"filterChip": "JxZQAa_filterChip",
			"dragHandle": "JxZQAa_dragHandle",
			"sessionList": "JxZQAa_sessionList",
			"gitHeader": "JxZQAa_gitHeader",
			"gitEmpty": "JxZQAa_gitEmpty",
			"empty": "JxZQAa_empty",
			"gitWorktreeRow": "JxZQAa_gitWorktreeRow",
			"fileGroup": "JxZQAa_fileGroup",
			"gitSection": "JxZQAa_gitSection",
			"gitLogLine1": "JxZQAa_gitLogLine1",
			"opFlagError": "JxZQAa_opFlagError",
			"diffHead": "JxZQAa_diffHead",
			"iconButton": "JxZQAa_iconButton",
			"gitName": "JxZQAa_gitName",
			"gitRowMain": "JxZQAa_gitRowMain",
			"gitLogRef": "JxZQAa_gitLogRef",
			"loadError": "JxZQAa_loadError",
			"gitBranchSelect": "JxZQAa_gitBranchSelect",
			"gitError": "JxZQAa_gitError",
			"gitLogMeta": "JxZQAa_gitLogMeta",
			"lensBar": "JxZQAa_lensBar",
			"dsh-row-in": "JxZQAa_dsh-row-in",
			"gitLogLine2": "JxZQAa_gitLogLine2",
			"opKind": "JxZQAa_opKind",
			"session": "JxZQAa_session",
			"gitCommitButton": "JxZQAa_gitCommitButton",
			"diffStats": "JxZQAa_diffStats",
			"root": "JxZQAa_root",
			"priorUnknown": "JxZQAa_priorUnknown",
			"gitLogHash": "JxZQAa_gitLogHash",
			"opTime": "JxZQAa_opTime",
			"gitLink": "JxZQAa_gitLink",
			"gitBadge": "JxZQAa_gitBadge",
			"gitPlaceholder": "JxZQAa_gitPlaceholder",
			"readError": "JxZQAa_readError",
			"gitLogRow": "JxZQAa_gitLogRow",
			"filterRow": "JxZQAa_filterRow",
			"opRow": "JxZQAa_opRow",
			"gitCommitInput": "JxZQAa_gitCommitInput",
			"diffPane": "JxZQAa_diffPane",
			"filePath": "JxZQAa_filePath",
			"opFlag": "JxZQAa_opFlag",
			"git": "JxZQAa_git"
		};
		//#endregion
    ...
    repeat return then true until while`)
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jkw/Documents/dshspace/plugins/dsh-better-sidebar/src/client/diff/diff.module.css.mjs
		const css$3 = ".TC6khq_rows{font-family:var(--ds-font-family-code,monospace);padding:4px 0 8px;font-size:11px}.TC6khq_row{cursor:default;align-items:flex-start;gap:5px;padding:0 10px;line-height:18px;display:flex}.TC6khq_row[data-folded=true]{cursor:pointer}.TC6khq_lineNo{width:2.5em;color:var(--dsw-alias-label-tertiary);text-align:right;user-select:none;flex:none;font-size:10px}.TC6khq_sign{text-align:center;user-select:none;flex:none;width:1em;font-weight:700}.TC6khq_row[data-kind=del] .TC6khq_sign,.TC6khq_row[data-kind=del] .TC6khq_text{color:var(--dsw-alias-state-error-primary)}.TC6khq_row[data-kind=add] .TC6khq_sign,.TC6khq_row[data-kind=add] .TC6khq_text{color:var(--dsw-alias-state-success-primary)}.TC6khq_row[data-kind=mod] .TC6khq_sign,.TC6khq_row[data-kind=mod] .TC6khq_text{color:var(--dsw-alias-state-business-primary)}.TC6khq_row[data-kind=context] .TC6khq_sign,.TC6khq_row[data-kind=context] .TC6khq_text{color:var(--dsw-alias-label-secondary)}.TC6khq_row[data-kind=read] .TC6khq_text{color:var(--dsw-alias-label-primary)}.TC6khq_row[data-kind=del]{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 8%, transparent)}.TC6khq_row[data-kind=add]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 8%, transparent)}.TC6khq_row[data-kind=mod]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.TC6khq_row .TC6khq_text{white-space:pre-wrap;word-break:break-word;flex:1;min-width:0}.TC6khq_row[data-folded=true] .TC6khq_text{white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.TC6khq_row[data-kind=meta] .TC6khq_metaText{color:var(--dsw-alias-label-tertiary);font-style:italic}.TC6khq_inlineChange{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 26%, transparent);border-radius:3px;padding:0 1px}.TC6khq_tokComment{color:var(--dsw-alias-label-tertiary);font-style:italic}.TC6khq_tokKeyword{color:color-mix(in oklab, var(--dsw-alias-state-business-primary) 55%, var(--dsw-alias-state-error-primary))}.TC6khq_tokString{color:color-mix(in oklab, var(--dsw-alias-state-success-primary) 45%, var(--dsw-alias-state-business-primary))}.TC6khq_tokType{color:color-mix(in oklab, var(--dsw-alias-brand-primary) 60%, var(--dsw-alias-state-success-primary))}.TC6khq_tokNumber{color:var(--dsw-alias-state-warn-primary)}.TC6khq_tokFunction{color:color-mix(in oklab, var(--dsw-alias-state-warn-primary) 55%, var(--dsw-alias-state-error-primary))}.TC6khq_tokMacro{color:color-mix(in oklab, var(--dsw-alias-state-error-primary) 45%, var(--dsw-alias-state-business-primary))}.TC6khq_foldRow{padding:0 10px}.TC6khq_foldRow[data-expandable=true]{cursor:pointer}.TC6khq_foldRow[data-expandable=true]:hover{background:var(--dsw-alias-interactive-bg-hover)}.TC6khq_foldRow[data-expanded=true]{cursor:default;padding:0}.TC6khq_foldRow[data-expanded=true] .TC6khq_foldMarker{display:none}.TC6khq_foldMarker{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-interactive-bg-hover);border-radius:4px;align-items:center;gap:5px;margin:2px 0;padding:2px 7px;display:inline-flex}.TC6khq_foldRow[data-expandable=true] .TC6khq_foldMarker{color:var(--dsw-alias-label-secondary)}.TC6khq_foldRow[data-expandable=true] .TC6khq_foldMarker:before{content:\"›\";color:var(--dsw-alias-label-tertiary);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out)}.TC6khq_expand{border:1px solid var(--dsw-alias-border-l1);width:calc(100% - 20px);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:6px;margin:4px 10px;padding:4px;font-size:11px;display:block}.TC6khq_expand:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.TC6khq_files,.TC6khq_fileBlock{flex-direction:column;display:flex}.TC6khq_file{width:100%;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:6px 10px;font-size:11px;display:flex}.TC6khq_file:disabled{cursor:default}.TC6khq_file:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.TC6khq_fileChevron{width:12px;color:var(--dsw-alias-label-tertiary);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex:none}.TC6khq_fileChevronExpanded{transform:rotate(90deg)}.TC6khq_filePath{font-family:var(--ds-font-family-code,monospace);color:var(--dsw-alias-label-primary);word-break:break-all;min-width:0}.TC6khq_fileOld{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-tertiary);font-family:var(--ds-font-family-code,monospace);flex:none;overflow:hidden}.TC6khq_fileTag{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:10px;line-height:16px}.TC6khq_fileStats{font-size:10px;font-family:var(--ds-font-family-code,monospace);flex:none;gap:5px;margin-left:auto;display:inline-flex}.TC6khq_statAdd{color:var(--dsw-alias-state-success-primary)}.TC6khq_statDel{color:var(--dsw-alias-state-error-primary)}.TC6khq_row:focus-visible,.TC6khq_foldRow:focus-visible,.TC6khq_file:focus-visible,.TC6khq_expand:focus-visible{outline:2px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}@media (prefers-reduced-motion:reduce){.TC6khq_fileChevron{transition:none}}";
		...
		var diff_module_css_default = {
			"metaText": "TC6khq_metaText",
			"fileChevron": "TC6khq_fileChevron",
			"fileOld": "TC6khq_fileOld",
			"row": "TC6khq_row",
			"tokFunction": "TC6khq_tokFunction",
			"statAdd": "TC6khq_statAdd",
			"statDel": "TC6khq_statDel",
			"tokType": "TC6khq_tokType",
			"sign": "TC6khq_sign",
			"fileChevronExpanded": "TC6khq_fileChevronExpanded",
			"foldMarker": "TC6khq_foldMarker",
			"tokNumber": "TC6khq_tokNumber",
			"rows": "TC6khq_rows",
			"tokKeyword": "TC6khq_tokKeyword",
			"tokComment": "TC6khq_tokComment",
			"tokString": "TC6khq_tokString",
			"files": "TC6khq_files",
			"fileBlock": "TC6khq_fileBlock",
			"foldRow": "TC6khq_foldRow",
			"text": "TC6khq_text",
			"tokMacro": "TC6khq_tokMacro",
			"inlineChange": "TC6khq_inlineChange",
			"file": "TC6khq_file",
			"expand": "TC6khq_expand",
			"fileTag": "TC6khq_fileTag",
			"filePath": "TC6khq_filePath",
			"fileStats": "TC6khq_fileStats",
			"lineNo": "TC6khq_lineNo"
		};
		//#endregion
...
Mode: this is a continuable side conversation. Your answers stay in this side thread and are viewed in the side panel; they are never delivered into the parent session.`;
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jkw/Documents/dshspace/plugins/dsh-better-sidebar/src/client/SubagentView.module.css.mjs
		const css$2 = "._0ObYcW_subagent{flex-direction:column;flex:1;min-height:0;display:flex}._0ObYcW_subagentHeader{flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}._0ObYcW_subagentTitle{min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._0ObYcW_subagentCount{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}._0ObYcW_subagentRefresh{width:24px;height:24px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;display:inline-flex}._0ObYcW_subagentRefresh:hover{background:var(--dsw-alias-interactive-bg-hover)}._0ObYcW_subagentBody{flex:1;min-height:0;padding:2px 6px 8px;overflow-y:auto}._0ObYcW_subagentRow{box-sizing:border-box;width:100%;min-height:50px;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;display:flex;position:relative}._0ObYcW_subagentRow:hover,._0ObYcW_subagentRow:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}._0ObYcW_subagentRowActive,._0ObYcW_subagentRowActive:hover,._0ObYcW_subagentRowActive:focus-visible{background:var(--dsw-alias-interactive-bg-active)}._0ObYcW_subagentRowDisabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}._0ObYcW_subagentRowDisabled:hover{background:0 0}._0ObYcW_subagentRowLoading{cursor:default}._0ObYcW_subagentDot{margin-top:4px}._0ObYcW_subagentContent{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}._0ObYcW_subagentLabel,._0ObYcW_subagentSecondary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._0ObYcW_subagentLabel{color:inherit;font-weight:400}._0ObYcW_subagentSecondary{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}._0ObYcW_subagentLive{min-width:0;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:4px;display:flex;overflow:hidden}._0ObYcW_subagentLiveTool{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-secondary);flex:none}._0ObYcW_subagentLiveArgs{min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._0ObYcW_subagentLiveText{-webkit-line-clamp:2;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-secondary);-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}._0ObYcW_subagentNode{min-width:0;position:relative}._0ObYcW_subagentChildren{margin-left:18px;padding-left:4px;position:relative}._0ObYcW_subagentChildren:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);height:26px;position:absolute;top:-26px;left:0}._0ObYcW_subagentChildren[aria-busy=true]:before{content:none}._0ObYcW_subagentChildren>._0ObYcW_subagentNode:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;top:0;bottom:0;left:-4px}._0ObYcW_subagentChildren>._0ObYcW_subagentNode:last-child:before{height:17px;bottom:auto}._0ObYcW_subagentChildren>._0ObYcW_subagentNode>._0ObYcW_subagentRow:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}._0ObYcW_subagentEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;flex-direction:column;gap:2px;padding:16px;display:flex}._0ObYcW_subagentEmptyHint{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-dimmed)}._0ObYcW_subagentError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:8px;padding:8px 10px;display:flex}._0ObYcW_subagentErrorRetry{height:24px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;padding:0 8px;display:inline-flex}._0ObYcW_subagentErrorRetry:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._0ObYcW_jobs{border-top:1px solid var(--dsw-alias-border-l2);margin-top:10px;padding-top:8px}._0ObYcW_jobsHeader{align-items:center;gap:8px;height:26px;padding:0 2px;display:flex}._0ObYcW_jobsTitle{min-width:0;font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._0ObYcW_jobsCount{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}._0ObYcW_jobsList{flex-direction:column;gap:2px;margin:0;padding:0;list-style:none;display:flex}._0ObYcW_jobsRow{border-radius:8px;align-items:center;gap:4px;display:flex}._0ObYcW_jobsRow:hover{background:var(--dsw-alias-interactive-bg-hover)}._0ObYcW_jobsRowSettled{opacity:.8}._0ObYcW_jobsRowSelected,._0ObYcW_jobsRowSelected:hover{background:var(--dsw-alias-interactive-bg-active)}._0ObYcW_jobsRowMain{min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:8px;outline:none;flex:1;align-items:flex-start;gap:8px;padding:6px 8px 6px 11px;display:flex}._0ObYcW_jobsRowMain:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}._0ObYcW_jobsDot{margin-top:5px}._0ObYcW_jobsContent{flex-direction:column;gap:1px;min-width:0;display:flex}._0ObYcW_jobsLabelLine{align-items:center;gap:6px;min-width:0;display:flex}._0ObYcW_jobsKind{text-overflow:ellipsis;white-space:nowrap;border:1px solid var(--dsw-alias-border-l2);max-width:90px;font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;padding:0 5px;line-height:14px;overflow:hidden}._0ObYcW_jobsLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}._0ObYcW_jobsSecondary{text-overflow:ellipsis;white-space:nowrap;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);overflow:hidden}._0ObYcW_jobsKill{width:22px;height:22px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;margin-right:4px;display:inline-flex}._0ObYcW_jobsKill:hover{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent);color:var(--dsw-alias-state-error-primary)}._0ObYcW_jobsKillArmed,._0ObYcW_jobsKillArmed:hover{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent);width:auto;height:20px;color:var(--dsw-alias-state-error-primary);font:var(--dsw-font-xxxs-strong-11);white-space:nowrap;padding:0 8px}._0ObYcW_jobsKill:disabled{opacity:.5;cursor:default}._0ObYcW_jobsKillError{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-error-primary);flex:none;margin-right:4px}._0ObYcW_jobsPane{z-index:1;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:8px;margin-top:4px;position:sticky;bottom:0;overflow:hidden;box-shadow:0 -6px 12px -8px #00000059}._0ObYcW_jobsPaneHeader{border-bottom:1px solid var(--dsw-alias-border-l1);align-items:center;gap:6px;height:28px;padding:0 4px 0 10px;display:flex}._0ObYcW_jobsPaneDot{flex:none}._0ObYcW_jobsPaneLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}._0ObYcW_jobsPaneStatus{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}._0ObYcW_jobsPaneClose{width:20px;height:20px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:5px;flex:none;justify-content:center;align-items:center;display:inline-flex}._0ObYcW_jobsPaneClose:hover{background:var(--dsw-alias-interactive-bg-hover)}._0ObYcW_jobsPanePre{max-height:200px;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;margin:0;padding:6px 10px;line-height:1.5;overflow:auto}._0ObYcW_jobsPaneHint{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);padding:8px 10px}._0ObYcW_jobsPaneError{color:var(--dsw-alias-state-error-primary)}";
		...
		var SubagentView_module_css_default = {
			"jobsPaneLabel": "_0ObYcW_jobsPaneLabel",
			"subagentError": "_0ObYcW_subagentError",
			"subagentDot": "_0ObYcW_subagentDot",
			"subagentLabel": "_0ObYcW_subagentLabel",
			"jobs": "_0ObYcW_jobs",
			"jobsPaneDot": "_0ObYcW_jobsPaneDot",
			"subagentHeader": "_0ObYcW_subagentHeader",
			"jobsRow": "_0ObYcW_jobsRow",
			"subagentErrorRetry": "_0ObYcW_subagentErrorRetry",
			"jobsDot": "_0ObYcW_jobsDot",
			"subagentNode": "_0ObYcW_subagentNode",
			"jobsKind": "_0ObYcW_jobsKind",
			"jobsPaneClose": "_0ObYcW_jobsPaneClose",
			"subagentTitle": "_0ObYcW_subagentTitle",
			"jobsRowMain": "_0ObYcW_jobsRowMain",
			"subagentContent": "_0ObYcW_subagentContent",
			"jobsContent": "_0ObYcW_jobsContent",
			"jobsSecondary": "_0ObYcW_jobsSecondary",
			"jobsPaneHint": "_0ObYcW_jobsPaneHint",
			"subagentLive": "_0ObYcW_subagentLive",
			"jobsPaneError": "_0ObYcW_jobsPaneError",
			"subagentRow": "_0ObYcW_subagentRow",
			"subagentRowDisabled": "_0ObYcW_subagentRowDisabled",
			"subagent": "_0ObYcW_subagent",
			"subagentRowLoading": "_0ObYcW_subagentRowLoading",
			"subagentCount": "_0ObYcW_subagentCount",
			"jobsHeader": "_0ObYcW_jobsHeader",
			"subagentChildren": "_0ObYcW_subagentChildren",
			"jobsKill": "_0ObYcW_jobsKill",
			"subagentLiveTool": "_0ObYcW_subagentLiveTool",
			"subagentSecondary": "_0ObYcW_subagentSecondary",
			"jobsPaneStatus": "_0ObYcW_jobsPaneStatus",
			"subagentRefresh": "_0ObYcW_subagentRefresh",
			"jobsKillError": "_0ObYcW_jobsKillError",
			"jobsPanePre": "_0ObYcW_jobsPanePre",
			"jobsLabel": "_0ObYcW_jobsLabel",
			"jobsPaneHeader": "_0ObYcW_jobsPaneHeader",
			"subagentBody": "_0ObYcW_subagentBody",
			"subagentRowActive": "_0ObYcW_subagentRowActive",
			"subagentLiveArgs": "_0ObYcW_subagentLiveArgs",
			"jobsKillArmed": "_0ObYcW_jobsKillArmed",
			"subagentEmptyHint": "_0ObYcW_subagentEmptyHint",
			"subagentLiveText": "_0ObYcW_subagentLiveText",
			"jobsTitle": "_0ObYcW_jobsTitle",
			"subagentEmpty": "_0ObYcW_subagentEmpty",
			"jobsRowSettled": "_0ObYcW_jobsRowSettled",
			"jobsList": "_0ObYcW_jobsList",
			"jobsCount": "_0ObYcW_jobsCount",
			"jobsRowSelected": "_0ObYcW_jobsRowSelected",
			"jobsLabelLine": "_0ObYcW_jobsLabelLine",
			"jobsPane": "_0ObYcW_jobsPane"
		};
		//#endregion
		...
		*  is exactly the changed tail. */
		...
		//#endregion
		//#region \0dsh-css:/Users/jkw/Documents/dshspace/plugins/dsh-better-sidebar/src/client/SideChatView.module.css.mjs
		const css$1 = "._55Ep7q_sidechat{flex-direction:column;flex:1;min-height:0;display:flex}._55Ep7q_sidechatDetailHeader{border-bottom:1px solid var(--dsw-alias-hairline);flex:none;align-items:center;gap:4px;min-height:36px;padding:4px 8px 4px 12px;display:flex}._55Ep7q_sidechatHeaderDot{flex:none}._55Ep7q_sidechatHeaderSpacer{flex:1;min-width:0}._55Ep7q_sidechatAgentBadge{border:1px solid var(--dsw-alias-hairline);max-width:55%;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;border-radius:999px;flex:none;padding:1px 8px;overflow:hidden}._55Ep7q_sidechatIconBtn{width:26px;height:26px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;transition:background-color .1s ease-out,color .1s ease-out;display:inline-flex}._55Ep7q_sidechatIconBtn:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._55Ep7q_sidechatIconBtn:disabled{opacity:.4;cursor:default}._55Ep7q_sidechatHero{min-height:0;color:var(--dsw-alias-label-tertiary);text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:8px;padding:24px 20px;animation:.2s ease-out _55Ep7q_sidechatFadeIn;display:flex}._55Ep7q_sidechatHeroTitle{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);font-weight:500}._55Ep7q_sidechatHeroDesc{max-width:300px;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);line-height:1.6}._55Ep7q_sidechatPrimaryBtn{background:var(--dsw-alias-button-info-fill,var(--dsw-alias-accent));color:var(--dsw-alias-button-info-label,var(--dsw-alias-accent-ink,#fff));font:var(--dsw-font-s-13);cursor:pointer;border:none;border-radius:999px;flex:none;margin-top:4px;padding:6px 14px;transition:opacity .1s ease-out}._55Ep7q_sidechatPrimaryBtn:hover:not(:disabled){opacity:.88}._55Ep7q_sidechatPrimaryBtn:disabled{opacity:.4;cursor:default}._55Ep7q_sidechatHint{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);flex:none;padding:4px 12px}._55Ep7q_sidechatError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-danger);flex:none;padding:4px 12px}._55Ep7q_sidechatScroll{flex-direction:column;flex:1;gap:10px;min-height:0;padding:10px 12px;display:flex;overflow-y:auto}._55Ep7q_sidechatScroll>*{animation:.18s ease-out _55Ep7q_sidechatRowIn}._55Ep7q_sidechatUser{background:var(--dsw-specific-bubble,var(--dsw-alias-bg-base));max-width:88%;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);overflow-wrap:anywhere;border-radius:18px;align-self:flex-end;padding:8px 14px}._55Ep7q_sidechatAssistant{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);overflow-wrap:anywhere;align-self:stretch}._55Ep7q_sidechatRow{align-self:stretch}._55Ep7q_sidechatRowLine{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);align-items:center;gap:6px;padding:1px 0;display:flex}._55Ep7q_sidechatRowSummary{cursor:pointer;user-select:none;list-style:none}._55Ep7q_sidechatRowSummary::-webkit-details-marker{display:none}._55Ep7q_sidechatRowSummary:hover{color:var(--dsw-alias-label-secondary)}._55Ep7q_sidechatRowStatic{cursor:default}._55Ep7q_sidechatRowChevron{flex:none;align-items:center;transition:transform .1s ease-out;display:inline-flex}._55Ep7q_sidechatRow[open] ._55Ep7q_sidechatRowChevron{transform:rotate(90deg)}._55Ep7q_sidechatRowIcon{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}._55Ep7q_sidechatRowLabel{text-overflow:ellipsis;white-space:nowrap;max-width:60%;color:var(--dsw-alias-label-secondary);flex:none;overflow:hidden}._55Ep7q_sidechatRowMono{font-family:var(--dsw-font-mono)}._55Ep7q_sidechatRowMeta{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-family:var(--dsw-font-mono);color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}._55Ep7q_sidechatRowFailed ._55Ep7q_sidechatRowLabel,._55Ep7q_sidechatRowFailed ._55Ep7q_sidechatRowMeta{color:var(--dsw-alias-danger)}._55Ep7q_sidechatRowBody{border-left:1px solid var(--dsw-alias-hairline);margin:2px 0 4px 7px;padding:2px 0 2px 10px}._55Ep7q_sidechatRowProse{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;overflow-wrap:anywhere;max-height:240px;overflow-y:auto}._55Ep7q_sidechatRowCode{font:var(--dsw-font-xxs-12);font-family:var(--dsw-font-mono);color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;max-height:220px;margin:0;padding:4px 0;overflow-y:auto}._55Ep7q_sidechatRowCode+._55Ep7q_sidechatRowCode{border-top:1px solid var(--dsw-alias-hairline)}._55Ep7q_sidechatRowBody>*{margin-top:2px}._55Ep7q_sidechatTurnSummary{max-width:88%;font:var(--dsw-font-xxs-12);font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-tertiary);user-select:none;align-self:flex-end;padding:0 2px}._55Ep7q_sidechatShimmerText{background-image:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-primary) 50%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-size:200% 100%;-webkit-background-clip:text;background-clip:text;animation:2.6s linear infinite _55Ep7q_sidechatSweep}._55Ep7q_sidechatStatus{flex:none;align-items:center;gap:8px;padding:2px 14px 6px;animation:.16s ease-out _55Ep7q_sidechatFadeIn;display:flex}._55Ep7q_sidechatStatusText{font:var(--dsw-font-xxs-12);background-image:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-primary) 50%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-size:200% 100%;-webkit-background-clip:text;background-clip:text;animation:2.6s linear infinite _55Ep7q_sidechatSweep}._55Ep7q_sidechatComposer{border:1px solid var(--dsw-alias-border-l2-darkmode-thin,var(--dsw-alias-hairline));background:var(--dsw-specific-input-major,var(--dsw-alias-bg-base));box-shadow:var(--dsw-shadow-lv2,none);border-radius:16px;flex-direction:column;flex:none;gap:4px;margin:0 8px 8px;padding:8px 8px 6px 14px;display:flex}._55Ep7q_sidechatComposerInput{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-s-14);resize:none;background:0 0;border:none;outline:none;max-height:132px;padding:2px 0;line-height:22px}._55Ep7q_sidechatComposerInput::placeholder{color:var(--dsw-alias-label-tertiary)}._55Ep7q_sidechatComposerBar{flex:none;align-items:center;gap:8px;min-height:28px;display:flex}._55Ep7q_sidechatComposerMeta{min-width:0;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._55Ep7q_sidechatSendBtn{background:var(--dsw-alias-button-info-fill,var(--dsw-alias-accent));width:28px;height:28px;color:var(--dsw-alias-button-info-label,var(--dsw-alias-accent-ink,#fff));cursor:pointer;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;transition:opacity .1s ease-out;animation:.12s ease-out _55Ep7q_sidechatBtnIn;display:inline-flex}._55Ep7q_sidechatSendBtn:hover:not(:disabled){opacity:.88}._55Ep7q_sidechatSendBtn:disabled{opacity:.35;cursor:default}@keyframes _55Ep7q_sidechatRowIn{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}@keyframes _55Ep7q_sidechatFadeIn{0%{opacity:0}to{opacity:1}}@keyframes _55Ep7q_sidechatBtnIn{0%{opacity:0;transform:scale(.85)}to{opacity:1;transform:scale(1)}}@keyframes _55Ep7q_sidechatSweep{0%{background-position:200% 0}to{background-position:-200% 0}}@media (prefers-reduced-motion:reduce){._55Ep7q_sidechatScroll>*,._55Ep7q_sidechatHero,._55Ep7q_sidechatStatus,._55Ep7q_sidechatSendBtn{animation:none}._55Ep7q_sidechatStatusText,._55Ep7q_sidechatShimmerText{color:var(--dsw-alias-label-tertiary);background-image:none;animation:none}._55Ep7q_sidechatRowChevron{transition:none}}";
		...
		var SideChatView_module_css_default = {
			"sidechatStatusText": "_55Ep7q_sidechatStatusText",
			"sidechatRowFailed": "_55Ep7q_sidechatRowFailed",
			"sidechatSendBtn": "_55Ep7q_sidechatSendBtn",
			"sidechatRowStatic": "_55Ep7q_sidechatRowStatic",
			"sidechatFadeIn": "_55Ep7q_sidechatFadeIn",
			"sidechatAgentBadge": "_55Ep7q_sidechatAgentBadge",
			"sidechatRowLine": "_55Ep7q_sidechatRowLine",
			"sidechatRowCode": "_55Ep7q_sidechatRowCode",
			"sidechatUser": "_55Ep7q_sidechatUser",
			"sidechatSweep": "_55Ep7q_sidechatSweep",
			"sidechatComposerBar": "_55Ep7q_sidechatComposerBar",
			"sidechatHeroTitle": "_55Ep7q_sidechatHeroTitle",
			"sidechatHeroDesc": "_55Ep7q_sidechatHeroDesc",
			"sidechatIconBtn": "_55Ep7q_sidechatIconBtn",
			"sidechatDetailHeader": "_55Ep7q_sidechatDetailHeader",
			"sidechatRowMono": "_55Ep7q_sidechatRowMono",
			"sidechatRowProse": "_55Ep7q_sidechatRowProse",
			"sidechatAssistant": "_55Ep7q_sidechatAssistant",
			"sidechatTurnSummary": "_55Ep7q_sidechatTurnSummary",
			"sidechatRowBody": "_55Ep7q_sidechatRowBody",
			"sidechatShimmerText": "_55Ep7q_sidechatShimmerText",
			"sidechatComposer": "_55Ep7q_sidechatComposer",
			"sidechatStatus": "_55Ep7q_sidechatStatus",
			"sidechatScroll": "_55Ep7q_sidechatScroll",
			"sidechatRowLabel": "_55Ep7q_sidechatRowLabel",
			"sidechatComposerInput": "_55Ep7q_sidechatComposerInput",
			"sidechat": "_55Ep7q_sidechat",
			"sidechatHeaderDot": "_55Ep7q_sidechatHeaderDot",
			"sidechatRowSummary": "_55Ep7q_sidechatRowSummary",
			"sidechatHeaderSpacer": "_55Ep7q_sidechatHeaderSpacer",
			"sidechatPrimaryBtn": "_55Ep7q_sidechatPrimaryBtn",
			"sidechatHero": "_55Ep7q_sidechatHero",
			"sidechatRowIn": "_55Ep7q_sidechatRowIn",
			"sidechatRowChevron": "_55Ep7q_sidechatRowChevron",
			"sidechatRowMeta": "_55Ep7q_sidechatRowMeta",
			"sidechatBtnIn": "_55Ep7q_sidechatBtnIn",
			"sidechatError": "_55Ep7q_sidechatError",
			"sidechatRowIcon": "_55Ep7q_sidechatRowIcon",
			"sidechatComposerMeta": "_55Ep7q_sidechatComposerMeta",
			"sidechatRow": "_55Ep7q_sidechatRow",
			"sidechatHint": "_55Ep7q_sidechatHint"
		};
		//#endregion
		...
		*/
		function executeHotkeyToggle(store) {
			const state = store.getSnapshot().state;
			if (!state) return false;
			const target = store.getPrefs().hotkeyToggleTarget ?? "both";
			if ((typeof window !== "undefined" ? isNarrowWidth(window.innerWidth) : false) || target === "panel") {
				store.reduce(togglePanel);
				return true;
			}
			if (target === "bottom") {
			...
			if (state.panelOpen || state.bottomOpen) {
		...
		*/
		function registerHotkeyToggle(store) {
			const onKey = (e) => {
		...
		*/
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: SideCardSection_module_css_default.title,
										children: t("settingsHotkeyToggleTitle")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: SideCardSection_module_css_default.desc,
										children: t("settingsHotkeyToggleDesc")
									})]
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: SideCardSection_module_css_default.control,
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectMenu, {
										...
										options: [
											{
												value: "both",
												title: t("settingsHotkeyToggleBoth")
											},
											{
												value: "panel",
												title: t("settingsHotkeyTogglePanel")
											},
											{
												value: "bottom",
												title: t("settingsHotkeyToggleBottom")
											}
										],
										onSelect: (next) => {
											const target = String(next);
											applyPref({ hotkeyToggleTarget: target });
											try {
												window.localStorage.setItem("dsh-cmdj-toggle:prefs", JSON.stringify({ target }));
												window.__dshCmdjToggle?.setPrefs?.({ target });
											} catch {}
										}
									})
								})]
		...
		//#endregion
		//#region \0dsh-css:/Users/jkw/Documents/dshspace/plugins/dsh-better-sidebar/src/client/layout.css.mjs
