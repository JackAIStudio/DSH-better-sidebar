...
globalThis.__dshChunks__["locale"] = (require) => {
	...
	*/
	...
	const ja = {
		...
		settingsHotkeyToggleTitle: "ホットキー切り替え対象 (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Cmd/Ctrl + J を押したときに展開・折りたたむパネルを選択",
		settingsHotkeyToggleBoth: "両方のパネル（右側と下側）",
		settingsHotkeyTogglePanel: "右側サイドバーのみ",
		settingsHotkeyToggleBottom: "下部パネルのみ",
	...
	*/
	const de = {
		...
		settingsHotkeyToggleTitle: "Hotkey-Umschaltziel (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Auswählen, welche Bedienfelder bei Cmd/Ctrl + J ein- oder ausgeklappt werden",
		settingsHotkeyToggleBoth: "Beide Bedienfelder (rechts und unten)",
		settingsHotkeyTogglePanel: "Nur rechte Seitenleiste",
		settingsHotkeyToggleBottom: "Nur unteres Bedienfeld",
	...
	*/
	...
	const fr = {
		...
		settingsHotkeyToggleTitle: "Cible du raccourci clavier (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Sélectionnez les panneaux à afficher ou masquer lors de Cmd/Ctrl + J",
		settingsHotkeyToggleBoth: "Les deux panneaux (droite et bas)",
		settingsHotkeyTogglePanel: "Barre latérale droite uniquement",
		settingsHotkeyToggleBottom: "Panneau inférieur uniquement",
	...
	const pt = {
		...
		settingsHotkeyToggleTitle: "Alvo do atalho de teclado (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Selecione quais painéis expandir ou recolher ao pressionar Cmd/Ctrl + J",
		settingsHotkeyToggleBoth: "Ambos os painéis (direita e inferior)",
		settingsHotkeyTogglePanel: "Apenas barra lateral direita",
		settingsHotkeyToggleBottom: "Apenas painel inferior",
	...
	*/
	const ko = {
		...
		settingsHotkeyToggleTitle: "단축키 전환 대상 (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Cmd/Ctrl + J를 누를 때 펼치거나 접을 패널 선택",
		settingsHotkeyToggleBoth: "모든 패널 (오른쪽 및 하단)",
		settingsHotkeyTogglePanel: "오른쪽 사이드바만",
		settingsHotkeyToggleBottom: "하단 패널만",
	...
	*/
	...
	const ar = {
		...
		settingsHotkeyToggleTitle: "هدف التبديل باختصار لوحة المفاتيح (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "حدد اللوحات التي سيتم توسيعها أو طيها عند الضغط على Cmd/Ctrl + J",
		settingsHotkeyToggleBoth: "كلا اللوحتين (اليمنى والسفلية)",
		settingsHotkeyTogglePanel: "الشريط الجانبي الأيمن فقط",
		settingsHotkeyToggleBottom: "اللوحة السفلية فقط",
	...
	*/
	...
	const hi = {
		...
		settingsHotkeyToggleTitle: "हॉटकी टॉगल लक्ष्य (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "चुनें कि Cmd/Ctrl + J दबाने पर कौन से पैनल विस्तृत या संक्षिप्त होंगे",
		settingsHotkeyToggleBoth: "दोनों पैनल (दायां और निचला)",
		settingsHotkeyTogglePanel: "केवल दायां साइडबार",
		settingsHotkeyToggleBottom: "केवल निचला पैनल",
	...
	*/
	const id = {
		...
		settingsHotkeyToggleTitle: "Target peralihan tombol pintas (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Pilih panel mana yang akan dibuka atau ditutup saat menekan Cmd/Ctrl + J",
		settingsHotkeyToggleBoth: "Kedua panel (kanan dan bawah)",
		settingsHotkeyTogglePanel: "Hanya bilah sisi kanan",
		settingsHotkeyToggleBottom: "Hanya panel bawah",
	...
	*/
	...
	const tr = {
		...
		settingsHotkeyToggleTitle: "Kısayol değiştirme hedefi (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Cmd/Ctrl + J tuşlarına basıldığında hangi panellerin genişletilip daraltılacağını seçin",
		settingsHotkeyToggleBoth: "Her iki panel (sağ ve alt)",
		settingsHotkeyTogglePanel: "Yalnızca sağ kenar çubuğu",
		settingsHotkeyToggleBottom: "Yalnızca alt panel",
	...
	*/
	...
	const vi = {
		...
		settingsHotkeyToggleTitle: "Mục tiêu chuyển đổi phím tắt (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Chọn các bảng điều khiển để mở rộng hoặc thu gọn khi nhấn Cmd/Ctrl + J",
		settingsHotkeyToggleBoth: "Cả hai bảng điều khiển (phải và dưới)",
		settingsHotkeyTogglePanel: "Chỉ thanh bên phải",
		settingsHotkeyToggleBottom: "Chỉ bảng điều khiển dưới",
	...
	*/
	...
	const th = {
		...
		settingsHotkeyToggleTitle: "เป้าหมายการสลับด้วยปุ่มลัด (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "เลือกแผงที่จะขยายหรือยุบเมื่อกด Cmd/Ctrl + J",
		settingsHotkeyToggleBoth: "ทั้งสองแผง (ขวาและล่าง)",
		settingsHotkeyTogglePanel: "เฉพาะแถบด้านข้างขวา",
		settingsHotkeyToggleBottom: "เฉพาะแผงด้านล่าง",
	...
	*/
	const ru = {
		...
		settingsHotkeyToggleTitle: "Цель переключения горячей клавишей (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Выберите, какие панели разворачивать или сворачивать по нажатию Cmd/Ctrl + J",
		settingsHotkeyToggleBoth: "Обе панели (правая и нижняя)",
		settingsHotkeyTogglePanel: "Только правая боковая панель",
		settingsHotkeyToggleBottom: "Только нижняя панель",
	...
	*/
	const it = {
		...
		settingsHotkeyToggleTitle: "Obiettivo della scorciatoia da tastiera (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Seleziona quali pannelli espandere o comprimere premendo Cmd/Ctrl + J",
		settingsHotkeyToggleBoth: "Entrambi i pannelli (destro e inferiore)",
		settingsHotkeyTogglePanel: "Solo barra laterale destra",
		settingsHotkeyToggleBottom: "Solo pannello inferiore",
	...
	*/
	const nl = {
		...
		settingsHotkeyToggleTitle: "Doel van sneltoets (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Kies welke panelen worden uitgeklapt of ingeklapt bij Cmd/Ctrl + J",
		settingsHotkeyToggleBoth: "Beide panelen (rechts en onder)",
		settingsHotkeyTogglePanel: "Alleen rechter zijbalk",
		settingsHotkeyToggleBottom: "Alleen onderpaneel",
	...
	const sv = {
		...
		settingsHotkeyToggleTitle: "Kortkommandots växlingsmål (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Välj vilka paneler som fälls ut eller ihop vid Cmd/Ctrl + J",
		settingsHotkeyToggleBoth: "Båda panelerna (höger och nederkant)",
		settingsHotkeyTogglePanel: "Endast höger sidofält",
		settingsHotkeyToggleBottom: "Endast nedre panelen",
	...
	*/
	...
	const pl = {
		...
		settingsHotkeyToggleTitle: "Cel skrótu klawiszowego (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "Wybierz, które panele mają być rozwijane lub zwijane po naciśnięciu Cmd/Ctrl + J",
		settingsHotkeyToggleBoth: "Oba panele (prawy i dolny)",
		settingsHotkeyTogglePanel: "Tylko prawy pasek boczny",
		settingsHotkeyToggleBottom: "Tylko dolny panel",
	...
	*/
	...
	const zhHK = {
		...
		settingsHotkeyToggleTitle: "快捷鍵切換目標 (Cmd/Ctrl + J)",
		settingsHotkeyToggleDesc: "選擇按下 Cmd/Ctrl + J 時展開或收起的面板",
		settingsHotkeyToggleBoth: "全部面板（右側與底部）",
		settingsHotkeyTogglePanel: "僅右側邊欄",
		settingsHotkeyToggleBottom: "僅底部面板",
